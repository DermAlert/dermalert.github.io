...
`;function G(){if(!document.getElementById("hero"))return;const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=document.getElementById("hero-title"),n=document.getElementById("hero-sub"),t=[r,n];function c(o,d=0){o&&(o.style.opacity="0",o.style.transform="translateY(16px) scale(.995)",o.style.transition=`opacity 600ms ease ${d}ms, transform 600ms ease ${d}ms`,o.style.willChange="opacity, transform")}function s(o){o&&(o.style.opacity="1",o.style.transform="translateY(0) scale(1)",setTimeout(()=>{o.style.willChange="auto"},700))}function u(o,d=1.02){if(!o)return;const m=o.style.transition?o.style.transition+", transform 220ms ease":"transform 220ms ease";o.style.transition=m;const p=()=>{e||(o.style.transform=`scale(${d})`,o.style.willChange="transform")},l=()=>{o.style.transform="scale(1)",o.style.willChange="auto"};o.addEventListener("pointerenter",p),o.addEventListener("pointerleave",l),o.addEventListener("focus",p),o.addEventListener("blur",l)}if(c(r,0),c(n,100),"IntersectionObserver"in window&&!e){const o=new IntersectionObserver(d=>{d.forEach(m=>{m.isIntersecting&&(s(m.target),o.unobserve(m.target))})},{threshold:.2});t.forEach(d=>d&&o.observe(d))}else t.forEach(s);u(r,1.02),u(n,1.015)}function Z(a=document){var h,g;const e=a.querySelector("#about-dermalert");if(!e||e.dataset.aboutWired==="true")return;e.dataset.aboutWired="true";const r=((h=window.matchMedia)==null?void 0:h.call(window,"(prefers-reduced-motion: reduce)").matches)??!1,n=((g=window.matchMedia)==null?void 0:g.call(window,"(hover: hover) and (pointer: fine)").matches)??!1,t=e.querySelector("#about-title"),c=e.querySelector("#about-sub"),s=e.querySelector("#about-media"),u=e.querySelector("#about-img"),o=e.querySelector("#about-highlight"),d=e.querySelector("#about-note"),m=(i,_=0)=>{i&&(i.style.opacity="0",i.style.transform="translateY(16px) scale(.995)",i.style.transition=`opacity 700ms cubic-bezier(.22,.75,.25,1) ${_}ms, transform 700ms cubic-bezier(.22,.75,.25,1) ${_}ms`,i.style.willChange="opacity, transform")},p=i=>{i&&(i.classList.remove("pre-anim"),i.classList.add("is-inview"),i.style.opacity="1",i.style.transform="translateY(0) scale(1)",setTimeout(()=>{i.style.willChange="auto"},800))},l=[t,c,s,o,d];if(l.forEach((i,_)=>m(i,_*90)),!r&&"IntersectionObserver"in window){const i=new IntersectionObserver(_=>{_.forEach(v=>{v.isIntersecting&&(p(v.target),i.unobserve(v.target))})},{threshold:.22,rootMargin:"0px 0px -10% 0px"});l.forEach(_=>_&&i.observe(_))}else l.forEach(i=>i&&p(i));if(n&&s){const i=()=>{r||(s.style.transition="transform 220ms ease",s.style.transform="scale(1.02)",s.style.willChange="transform")},_=()=>{s.style.transform="scale(1)",s.style.willChange="auto"};s.addEventListener("pointerenter",i),s.addEventListener("pointerleave",_),s.addEventListener("focus",i,!0),s.addEventListener("blur",_,!0),u&&(u.setAttribute("draggable","false"),u.style.userSelect="none",u.style.pointerEvents="none")}}function W(){const a=document.getElementById("features-pills");if(!a)return;const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=Array.from(a.querySelectorAll("li"));r.forEach((t,c)=>{t.style.opacity="0",t.style.transform="translateY(8px)",t.style.transition=`opacity 480ms ease ${c*60}ms, transform 480ms ease ${c*60}ms`;const s=t.style.transition?t.style.transition+", transform 160ms ease":"transform 160ms ease";t.style.transition=s;const u=()=>{e||(t.style.transform="translateY(-2px) scale(1.01)",t.style.willChange="transform")},o=()=>{t.style.transform="translateY(0) scale(1)",t.style.willChange="auto"};t.addEventListener("pointerenter",u),t.addEventListener("pointerleave",o),t.addEventListener("focusin",u),t.addEventListener("focusout",o)});const n=t=>{t.style.opacity="1",t.style.transform="translateY(0) scale(1)"};if("IntersectionObserver"in window&&!e){const t=new IntersectionObserver(c=>{c.forEach(s=>{s.isIntersecting&&(n(s.target),t.unobserve(s.target))})},{threshold:.15});r.forEach(c=>t.observe(c))}else r.forEach(n)}function Q(a=document){const e=a.querySelector("#functionalities");if(!e||e.dataset.featuresBaseWired==="true")return;e.dataset.featuresBaseWired="true",function(){if(!e.querySelector(".bg-animate"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){e.classList.add("inview");return}const i=new IntersectionObserver(([_])=>{_.isIntersecting&&(e.classList.add("inview"),i.disconnect())},{root:null,threshold:.2,rootMargin:"-10% 0px -10% 0px"});i.observe(e)}();const r=l=>{l&&(l.style.display="block",requestAnimationFrame(()=>l.style.opacity="1"))},n=l=>{l&&(l.style.opacity="0",l.style.display="none")},t=e.querySelector("#func-illustration"),c=[e.querySelector("#figma-embed-1"),e.querySelector("#figma-embed-2"),e.querySelector("#figma-embed-3")],s=Array.from(e.querySelectorAll("#func-cards .func-card")),u=l=>{const h=Number(l)-1;c.forEach((g,i)=>i===h?r(g):n(g)),t&&(t.classList.add("hidden"),t.style.opacity="0",t.style.display="none"),s.forEach(g=>{const i=g.dataset.step===String(l);g.classList.toggle("opacity-50",!i);const _=g.querySelector(".func-cta");_&&_.classList.toggle("hidden",!i),g.setAttribute("aria-pressed",i?"true":"false")})};s.length&&(s.forEach(l=>{const h=Number(l.dataset.step);l.addEventListener("click",()=>u(h)),l.addEventListener("keydown",g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),u(h))})}),u(1));const o=[e.querySelector("#figma-embed-m1"),e.querySelector("#figma-embed-m2"),e.querySelector("#figma-embed-m3")],d=e.querySelector("#func-illustration-mob"),m=Array.from(e.querySelectorAll("details.func-card[data-step]")),p=l=>{const h=Number(l)-1;o.forEach((g,i)=>i===h?r(g):n(g)),d&&(d.classList.add("hidden"),d.style.opacity="0",d.style.display="none")};if(m.length){m.forEach(h=>{h.addEventListener("toggle",()=>{if(!h.open)return;const g=Number(h.dataset.step);p(g),m.forEach(i=>{i!==h&&i.open&&(i.open=!1)})})});const l=m.find(h=>h.open)||m[0];l&&!l.open&&(l.open=!0),p(Number(l.dataset.step||1))}}function Y(a=document){const e=a.querySelector("#faq");if(!e||e.dataset.faqWired==="true")return;e.dataset.faqWired="true";const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,n=[e.querySelector("#faq-title"),e.querySelector("#faq-sub")];if(n.forEach((o,d)=>{o&&(o.style.opacity="0",o.style.transform="translateY(16px)",o.style.transition=`opacity 600ms ease ${d*80}ms, transform 600ms ease ${d*80}ms`)}),"IntersectionObserver"in window&&!r){const o=new IntersectionObserver(d=>{d.forEach(m=>{m.isIntersecting&&(m.target.style.opacity="1",m.target.style.transform="translateY(0)",o.unobserve(m.target))})},{threshold:.2});n.forEach(d=>d&&o.observe(d))}else n.forEach(o=>{o&&(o.style.opacity="1",o.style.transform="translateY(0)")});const t=Array.from(e.querySelectorAll(".faq-item"));function c(o,d,m,p,l){l?(o.classList.add("bg-[#2F488A]","text-white"),o.classList.remove("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.add("bg-[#2F488A]","text-white/95"),d.classList.remove("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),p&&(p.classList.remove("text-[#1D366F]","dark:text-white"),p.classList.add("text-white")),m.classList.remove("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"),m.classList.add("text-white","border-white/40")):(o.classList.remove("bg-[#2F488A]","text-white"),o.classList.add("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.remove("bg-[#2F488A]","text-white/95"),d.classList.add("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),p&&(p.classList.remove("text-white"),p.classList.add("text-[#1D366F]","dark:text-white")),m.classList.remove("text-white","border-white/40"),m.classList.add("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"))}function s(o,d){const m=o.querySelector(".faq-trigger"),p=o.querySelector(".faq-panel"),l=o.querySelector(".faq-icon"),h=o.querySelector(".faq-title"),g=l==null?void 0:l.querySelector(".plus"),i=l==null?void 0:l.querySelector(".minus");if(o.classList.toggle("is-open",d),c(m,p,l,h,d),d){if(r)p.style.height="auto";else{p.style.overflow="hidden",p.style.height="auto";const _=p.scrollHeight;p.style.height="0px",requestAnimationFrame(()=>{p.style.transition="height 260ms ease",p.style.height=_+"px"}),setTimeout(()=>{p.style.transition="",p.style.height="auto",p.style.overflow=""},300)}g==null||g.classList.add("hidden"),i==null||i.classList.remove("hidden")}else{const _=p.scrollHeight;p.style.height=_+"px",p.style.overflow="hidden",requestAnimationFrame(()=>{p.style.transition=r?"":"height 220ms ease",p.style.height="0px"}),setTimeout(()=>{p.style.transition="",p.style.overflow=""},r?0:240),g==null||g.classList.remove("hidden"),i==null||i.classList.add("hidden")}}if(t.forEach((o,d)=>s(o,d===0)),t.forEach(o=>{o.querySelector(".faq-trigger").addEventListener("click",()=>{const m=!o.classList.contains("is-open");t.forEach(p=>p!==o&&s(p,!1)),s(o,m)})}),e.querySelector(".faq-cta")){const o="faqShimmer"+Math.random().toString(36).slice(2),d=document.createElement("style");d.textContent=`
      @keyframes ${o} {
