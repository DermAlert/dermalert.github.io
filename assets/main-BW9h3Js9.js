(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))c(n);new MutationObserver(n=>{for(const p of n)if(p.type==="childList")for(const _ of p.addedNodes)_.tagName==="LINK"&&_.rel==="modulepreload"&&c(_)}).observe(document,{childList:!0,subtree:!0});function i(n){const p={};return n.integrity&&(p.integrity=n.integrity),n.referrerPolicy&&(p.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?p.credentials="include":n.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function c(n){if(n.ep)return;n.ep=!0;const p=i(n);fetch(n.href,p)}})();const ja=`<!-- HEADER fixo + spacer dinâmico -->\r
...
`,za=`<section id="hero" class="relative w-full overflow-hidden text-white">
...
`,Ha=`<!-- PARTNERS / APOIO E INICIATIVA -->\r
...
`,Ua=`<section id="functionalities" class="dermalert-feature-flow" aria-labelledby="feature-flow-title">
...
`,Na=`<section id="who-for" class="who-section">
...
`,Oa=`<section id="faq" class="w-full py-14 bg-[#F5F9FF] dark:bg-transparent">
...
`,Va=`<!-- ===== FOOTER (global + i18n + dark mode) ===== -->
...
`;function Ga(){if(!document.getElementById("hero"))return;const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,i=document.getElementById("hero-title"),c=document.getElementById("hero-sub"),n=[i,c];function p(o,f=0){o&&(o.style.opacity="0",o.style.transform="translateY(16px) scale(.995)",o.style.transition=`opacity 600ms ease ${f}ms, transform 600ms ease ${f}ms`,o.style.willChange="opacity, transform")}function _(o){o&&(o.style.opacity="1",o.style.transform="translateY(0) scale(1)",setTimeout(()=>{o.style.willChange="auto"},700))}function g(o,f=1.02){if(!o)return;const b=o.style.transition?o.style.transition+", transform 220ms ease":"transform 220ms ease";o.style.transition=b;const d=()=>{a||(o.style.transform=`scale(${f})`,o.style.willChange="transform")},x=()=>{o.style.transform="scale(1)",o.style.willChange="auto"};o.addEventListener("pointerenter",d),o.addEventListener("pointerleave",x),o.addEventListener("focus",d),o.addEventListener("blur",x)}if(p(i,0),p(c,100),"IntersectionObserver"in window&&!a){const o=new IntersectionObserver(f=>{f.forEach(b=>{b.isIntersecting&&(_(b.target),o.unobserve(b.target))})},{threshold:.2});n.forEach(f=>f&&o.observe(f))}else n.forEach(_);g(i,1.02),g(c,1.015)}function $a(r=document){var F,q;const a=r.querySelector("#about-dermalert");if(!a||a.dataset.aboutWired==="true")return;a.dataset.aboutWired="true";const i=((F=window.matchMedia)==null?void 0:F.call(window,"(prefers-reduced-motion: reduce)").matches)??!1,c=((q=window.matchMedia)==null?void 0:q.call(window,"(hover: hover) and (pointer: fine)").matches)??!1,n=a.querySelector("#about-kicker"),p=a.querySelector("#about-title"),_=a.querySelector("#about-sub"),g=a.querySelector("#about-media"),o=a.querySelector("#about-img"),f=a.querySelector("#about-highlight"),b=a.querySelector("#about-note"),d=(y,k=0)=>{y&&(y.style.opacity="0",y.style.transform="translateY(16px) scale(.995)",y.style.transition=`opacity 700ms cubic-bezier(.22,.75,.25,1) ${k}ms, transform 700ms cubic-bezier(.22,.75,.25,1) ${k}ms`,y.style.willChange="opacity, transform")},x=y=>{y&&(y.classList.remove("pre-anim"),y.classList.add("is-inview"),y.style.opacity="1",y.style.transform="translateY(0) scale(1)",setTimeout(()=>{y.style.willChange="auto"},800))},M=[n,p,_,g,f,b];if(M.forEach((y,k)=>d(y,k*90)),!i&&"IntersectionObserver"in window){const y=new IntersectionObserver(k=>{k.forEach(B=>{B.isIntersecting&&(x(B.target),y.unobserve(B.target))})},{threshold:.22,rootMargin:"0px 0px -10% 0px"});M.forEach(k=>k&&y.observe(k))}else M.forEach(y=>y&&x(y));if(c&&g){const y=()=>{i||(g.style.transition="transform 220ms ease",g.style.transform="scale(1.02)",g.style.willChange="transform")},k=()=>{g.style.transform="scale(1)",g.style.willChange="auto"};g.addEventListener("pointerenter",y),g.addEventListener("pointerleave",k),g.addEventListener("focus",y,!0),g.addEventListener("blur",k,!0),o&&(o.setAttribute("draggable","false"),o.style.userSelect="none",o.style.pointerEvents="none")}}function Wa(){const r=document.getElementById("features-pills");if(!r)return;const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,i=Array.from(r.querySelectorAll("li"));i.forEach((n,p)=>{n.style.opacity="0",n.style.transform="translateY(8px)",n.style.transition=`opacity 480ms ease ${p*60}ms, transform 480ms ease ${p*60}ms`;const _=n.style.transition?n.style.transition+", transform 160ms ease":"transform 160ms ease";n.style.transition=_;const g=()=>{a||(n.style.transform="translateY(-2px) scale(1.01)",n.style.willChange="transform")},o=()=>{n.style.transform="translateY(0) scale(1)",n.style.willChange="auto"};n.addEventListener("pointerenter",g),n.addEventListener("pointerleave",o),n.addEventListener("focusin",g),n.addEventListener("focusout",o)});const c=n=>{n.style.opacity="1",n.style.transform="translateY(0) scale(1)"};if("IntersectionObserver"in window&&!a){const n=new IntersectionObserver(p=>{p.forEach(_=>{_.isIntersecting&&(c(_.target),n.unobserve(_.target))})},{threshold:.15});i.forEach(p=>n.observe(p))}else i.forEach(c)}const Ne={"pt-BR":{status_1:"Cadastro",status_2:"Lesão",status_3:"Triagem",screen1_kicker:"Novo atendimento",screen1_title:"Identificação segura",secure_chip:"Seguro",screen1_field_name:"Nome",screen1_field_birth:"Nascimento",screen1_field_card:"Cartão SUS",screen1_field_unit:"Unidade",screen1_field_consent:"Consentimento",screen1_consent_ok:"Registrado",screen1_field_sync:"Sincronização",screen1_sync_ready:"Pronta",screen1_action:"Salvar cadastro",screen2_kicker:"Etapa clínica",screen2_title:"Registrar lesão",screen2_question_label:"Sinais observados",screen2_chip_a:"Assimetria",screen2_chip_b:"Bordas",screen2_chip_c:"Cor",screen2_chip_d:"Evolução",screen2_check1:"Perguntas guiadas completas",screen2_check2:"Imagem clínica vinculada",screen2_action:"Enviar para triagem",screen3_kicker:"Resultado",screen3_title:"Triagem e pesquisa",screen3_badge:"OK",screen3_priority_label:"Prioridade",screen3_priority_value:"Avaliação médica",screen3_priority_note:"Caso organizado para encaminhamento.",screen3_check1:"Histórico clínico salvo",screen3_check2:"Dados prontos para análise",screen3_check3:"Encaminhamento rastreável",screen3_action:"Concluir atendimento",metric_steps:"etapas guiadas",metric_privacy:"dados sensíveis protegidos",metric_referral:"encaminhamento rastreável"},en:{status_1:"Registration",status_2:"Lesion",status_3:"Triage",screen1_kicker:"New visit",screen1_title:"Secure identification",secure_chip:"Secure",screen1_field_name:"Name",screen1_field_birth:"Birth date",screen1_field_card:"Health ID",screen1_field_unit:"Unit",screen1_field_consent:"Consent",screen1_consent_ok:"Recorded",screen1_field_sync:"Sync",screen1_sync_ready:"Ready",screen1_action:"Save registration",screen2_kicker:"Clinical step",screen2_title:"Register lesion",screen2_question_label:"Observed signs",screen2_chip_a:"Asymmetry",screen2_chip_b:"Borders",screen2_chip_c:"Color",screen2_chip_d:"Evolution",screen2_check1:"Guided questions complete",screen2_check2:"Clinical image linked",screen2_action:"Send to triage",screen3_kicker:"Result",screen3_title:"Triage & research",screen3_badge:"OK",screen3_priority_label:"Priority",screen3_priority_value:"Medical review",screen3_priority_note:"Case organized for referral.",screen3_check1:"Clinical history saved",screen3_check2:"Data ready for analysis",screen3_check3:"Traceable referral",screen3_action:"Finish visit",metric_steps:"guided steps",metric_privacy:"sensitive data protected",metric_referral:"traceable referral"},es:{status_1:"Registro",status_2:"Lesión",status_3:"Triaje",screen1_kicker:"Nueva atención",screen1_title:"Identificación segura",secure_chip:"Seguro",screen1_field_name:"Nombre",screen1_field_birth:"Nacimiento",screen1_field_card:"Tarjeta de salud",screen1_field_unit:"Unidad",screen1_field_consent:"Consentimiento",screen1_consent_ok:"Registrado",screen1_field_sync:"Sincronización",screen1_sync_ready:"Lista",screen1_action:"Guardar registro",screen2_kicker:"Etapa clínica",screen2_title:"Registrar lesión",screen2_question_label:"Signos observados",screen2_chip_a:"Asimetría",screen2_chip_b:"Bordes",screen2_chip_c:"Color",screen2_chip_d:"Evolución",screen2_check1:"Preguntas guiadas completas",screen2_check2:"Imagen clínica vinculada",screen2_action:"Enviar a triaje",screen3_kicker:"Resultado",screen3_title:"Triaje e investigación",screen3_badge:"OK",screen3_priority_label:"Prioridad",screen3_priority_value:"Evaluación médica",screen3_priority_note:"Caso organizado para derivación.",screen3_check1:"Historial clínico guardado",screen3_check2:"Datos listos para análisis",screen3_check3:"Derivación rastreable",screen3_action:"Concluir atención",metric_steps:"etapas guiadas",metric_privacy:"datos sensibles protegidos",metric_referral:"derivación rastreable"}};function Oe(){const r=localStorage.getItem("lang");if(r)return r;const a=document.documentElement.lang||"pt-BR";return a.toLowerCase().startsWith("pt")?"pt-BR":a}function Za(r){return Ne[r]||Ne["pt-BR"]}function le(r,a){!r||typeof a!="string"||r.textContent===a||(r.textContent=a)}function Ya(r=document){var Ue;const a=r.querySelector("#functionalities");if(!a||a.dataset.featuresBaseWired==="true")return;a.dataset.featuresBaseWired="true";const i=a.querySelector("[data-feature-flow]")||a,c=Array.from(a.querySelectorAll("[data-flow-screen]")),n=Array.from(a.querySelectorAll("[data-flow-card]")),p=Array.from(a.querySelectorAll("[data-flow-step-button]")),_=a.querySelector("[data-flow-status]"),g=a.querySelector("[data-flow-prev]"),o=a.querySelector("[data-flow-next]"),f=Array.from(a.querySelectorAll(".flow-card-meter span")),b=a.querySelector("[data-flow-swipe]"),d=a.querySelector(".register-screen"),x=Array.from(a.querySelectorAll("[data-register-page]")),M=a.querySelector(".register-progress span"),F=a.querySelector(".register-step"),q=Array.from(a.querySelectorAll("[data-register-input]")),y=Array.from(a.querySelectorAll("[data-register-input-frame]")),k=a.querySelector("[data-register-next]"),B=a.querySelector("[data-register-back]"),A=a.querySelector("[data-register-actions]"),Q=a.querySelector(".register-keyboard[data-register-keyboard]"),ue=a.querySelector("[data-register-clear]"),pe=Array.from(a.querySelectorAll("[data-register-upload]")),S=a.querySelector("[data-register-history]"),C=a.querySelector(".lesion-screen"),me=Array.from(a.querySelectorAll("[data-lesion-page]")),De=a.querySelector("[data-lesion-progress]"),aa=a.querySelector("[data-lesion-step-label]"),V=a.querySelector("[data-lesion-next]"),ge=a.querySelector("[data-lesion-back]"),G=a.querySelector("[data-lesion-actions]"),_e=a.querySelector("[data-lesion-clear]"),se=a.querySelector("[data-lesion-upload-grid]"),ta=Array.from(a.querySelectorAll("[data-lesion-add-image]")),fe=Array.from(a.querySelectorAll("[data-lesion-location]")),z=a.querySelector("[data-lesion-image-flow]"),Le=Array.from(a.querySelectorAll("[data-lesion-image-panel]")),sa=Array.from(a.querySelectorAll("[data-lesion-image-close]")),ra=Array.from(a.querySelectorAll("[data-lesion-open-camera]")),na=Array.from(a.querySelectorAll("[data-lesion-open-gallery]")),oa=Array.from(a.querySelectorAll("[data-lesion-capture-image]")),ia=Array.from(a.querySelectorAll("[data-lesion-use-image]")),ca=Array.from(a.querySelectorAll("[data-lesion-gallery-item]")),la=Array.from(a.querySelectorAll("[data-lesion-preview-image]")),da=Array.from(a.querySelectorAll("[data-lesion-delete-image]")),ua=Array.from(a.querySelectorAll("[data-lesion-remove-confirm]")),pa=Array.from(a.querySelectorAll("[data-lesion-remove-cancel]")),he=a.querySelector("[data-feature-image-demo]"),Pe=Array.from(a.querySelectorAll("[data-feature-image-panel]")),ma=Array.from(a.querySelectorAll("[data-feature-image-target]")),ga=Array.from(a.querySelectorAll("[data-feature-gallery-item]")),_a=Array.from(a.querySelectorAll("[data-feature-image-dot]"));if(!c.length||!n.length)return;const be=c.map(e=>Number(e.dataset.flowScreen)).filter(e=>Number.isFinite(e)),K=Math.min(...be),ve=Math.max(...be);let D=K,L=1,P=1,ye=0,we=!1,R=!1,U=q[0]||null,$=!1;const W=x.length||1,xe=me.length||1,Fe=8;function X(e=D){return e>=ve?K:e+1}function Me(e=D){return e<=K?ve:e-1}function fa(){f.forEach(e=>{e.style.width=""})}function Be(e){if(!he||!Pe.length)return;const t=e==="camera-captured"?"camera":e;he.classList.toggle("is-camera-captured",e==="camera-captured"),he.dataset.imageState=e,Pe.forEach(s=>{const u=s.dataset.featureImagePanel===t;s.classList.toggle("is-active",u),s.setAttribute("aria-hidden",String(!u))}),_a.forEach(s=>{s.classList.toggle("is-active",s.dataset.featureImageDot===e)})}function ke(e=Oe()){const t=Za(e);a.querySelectorAll("[data-flow-i18n]").forEach(s=>{const u=s.getAttribute("data-flow-i18n");le(s,t[u])}),le(_,t[`status_${D}`])}function I(e){if(!be.includes(Number(e)))return;const t=Number(e),s=D,u=D===ve&&t===K,v=t>D||u;i.dataset.direction=v?"forward":"back",D=t,fa(),b==null||b.classList.toggle("is-register-active",D===1),D!==1&&($=!1),D!==2&&ee(),s!==D&&D===3&&Be("choice"),c.forEach(m=>{const h=Number(m.dataset.flowScreen)===D;m.classList.toggle("is-active",h),m.setAttribute("aria-hidden",String(!h))}),n.forEach(m=>{const h=Number(m.dataset.step)===D;m.classList.toggle("is-active",h),m.setAttribute("aria-selected",String(h))}),p.forEach(m=>{const h=Number(m.dataset.step)===D;m.classList.toggle("is-active",h),m.setAttribute("aria-current",h?"step":"false")}),ke()}function j(){const e=O();(e==null?void 0:e.dataset.registerKeyboard)==="true"&&(d==null||d.classList.add("has-keyboard"))}function Ae(){if(!V)return;const e=P===1||P===2&&R;V.classList.toggle("has-value",e),V.disabled=P===2&&!R}function ha(){se&&(se.classList.remove("is-empty-shake"),se.offsetWidth,se.classList.add("is-empty-shake"))}function J(e,t={}){if(!me.length)return;const s=Math.min(Math.max(Number(e),1),xe);if(!Number.isFinite(s))return;const u=s<P||t.source==="back";P=s,C==null||C.setAttribute("data-lesion-direction",u?"back":"forward"),me.forEach(h=>{const w=Number(h.dataset.lesionPage)===P;h.classList.toggle("is-active",w),h.setAttribute("aria-hidden",String(!w))});const v=P===xe,m=Math.min(P,2);C==null||C.classList.toggle("is-complete",v),C==null||C.classList.toggle("has-images",R),G==null||G.classList.toggle("is-first",P===1),G==null||G.classList.toggle("is-final",P===2),De&&(De.style.width=`${m/Fe*100}%`),le(aa,`Passo ${m} de ${Fe}`),Ae()}function ba(){if(P===1){J(2,{source:"next"});return}if(P===2){if(!R){ha();return}J(3,{source:"next"});return}I(X())}function va(){P>1&&P<xe&&J(P-1,{source:"back"})}function N(e){if(!z||!Le.length)return;const t=e==="camera-captured"?"camera":e;z.classList.add("is-open"),z.classList.toggle("is-camera-captured",e==="camera-captured"),z.dataset.imageState=e,z.setAttribute("aria-hidden","false"),C==null||C.classList.add("is-image-flow-open"),Le.forEach(s=>{const u=s.dataset.lesionImagePanel===t;s.classList.toggle("is-active",u),s.setAttribute("aria-hidden",String(!u))})}function Ie(){N("choice")}function ee(){z&&(z.classList.remove("is-open","is-camera-captured"),z.removeAttribute("data-image-state"),z.setAttribute("aria-hidden","true"),C==null||C.classList.remove("is-image-flow-open"))}function ya(){R=!0,C==null||C.classList.add("has-images"),ee(),Ae()}function wa(){R=!1,C==null||C.classList.remove("has-images"),ee(),Ae()}function xa(){R=!1,C==null||C.classList.remove("has-images"),ee(),fe.forEach(e=>{e.classList.remove("is-selected"),e.setAttribute("aria-expanded","false")}),J(1,{source:"clear"})}function O(){return x.find(e=>Number(e.dataset.registerPage)===L)||x[0]||null}function H(){const e=O();return(e==null?void 0:e.querySelector("[data-register-input]"))||U||q[0]||null}function je(e){if(!e)return;const t=e.value.replace(/\D/g,"");if(e.id==="feature-register-cpf"){e.value=t.slice(0,11).replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d{1,2})$/,"$1-$2");return}if(e.id==="feature-register-birth"){e.value=t.slice(0,8).replace(/(\d{2})(\d)/,"$1/$2").replace(/(\d{2})(\d)/,"$1/$2");return}if(e.id==="feature-register-sus"){e.value=t.slice(0,15);return}e.id==="feature-register-phone"&&(e.value=t.slice(0,11).replace(/(\d{2})(\d)/,"($1) $2").replace(/(\d{5})(\d{1,4})$/,"$1-$2"))}function ka(e){return!!a.querySelector(`[data-register-choice="${e}"].is-selected`)}function Aa(){return!!a.querySelector("[data-register-consent].is-selected")}function Ca(e=L){return x.find(t=>Number(t.dataset.registerPage)===Number(e))||null}function re(e){return(e==null?void 0:e.value.replace(/\D/g,""))||""}function Ea(e){const t=e.replace(/\D/g,"");if(t.length!==8)return!1;const s=Number(t.slice(0,2)),u=Number(t.slice(2,4)),v=Number(t.slice(4)),m=new Date(v,u-1,s),h=new Date;return v>=1900&&m.getFullYear()===v&&m.getMonth()===u-1&&m.getDate()===s&&m<=h}function qa(e){return/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(e.trim())}function Sa(e){if(!e)return null;let t=e.querySelector("[data-register-error]");return t||(t=document.createElement("p"),t.className="register-validation-message",t.dataset.registerError="",t.id=`feature-register-error-${e.dataset.registerPage}`,t.setAttribute("role","alert"),t.setAttribute("aria-live","polite"),t.hidden=!0,e.append(t),t)}function Ce(e=O()){if(!e)return;e.classList.remove("has-validation-error"),e.querySelectorAll(".has-error, .is-empty-shake").forEach(s=>{s.classList.remove("has-error","is-empty-shake")}),e.querySelectorAll('[aria-invalid="true"]').forEach(s=>{s.removeAttribute("aria-invalid"),s.removeAttribute("aria-describedby")});const t=e.querySelector("[data-register-error]");t&&(t.hidden=!0,t.textContent="")}function Da(){x.forEach(e=>Ce(e))}function ne(e=L){const t=Ca(e);if(!t)return{valid:!0,page:null};const s=Number(t.dataset.registerPage),v=Array.from(t.querySelectorAll("[data-register-input-frame]"))[0]||null,m=l=>t.querySelector(`#${l}`),h=l=>(l==null?void 0:l.closest("[data-register-input-frame]"))||v,w=(l,E,Ia=null)=>({valid:!1,page:t,message:l,target:E,input:Ia});if(s===1){const l=m("feature-register-name");if(((l==null?void 0:l.value.trim().length)||0)<3)return w("Informe o nome completo do paciente.",h(l),l)}if(s===2){const l=m("feature-register-cpf"),E=re(l);if(!E)return w("Informe o CPF do paciente.",h(l),l);if(E.length!==11)return w("CPF deve ter 11 digitos.",h(l),l)}if(s===3){const l=m("feature-register-birth"),E=re(l);if(!E)return w("Informe a data de nascimento.",h(l),l);if(E.length!==8)return w("Use o formato dd/mm/aaaa.",h(l),l);if(!Ea(l.value))return w("Informe uma data de nascimento valida.",h(l),l)}if(s===4&&!ka("gender"))return w("Selecione uma opcao para continuar.",t.querySelector(".register-options"));if(s===5){const l=m("feature-register-email"),E=m("feature-register-phone");if(!(l!=null&&l.value.trim()))return w("Informe um e-mail para retorno.",h(l),l);if(!qa(l.value))return w("Digite um e-mail valido.",h(l),l);if(E!=null&&E.value.trim()&&re(E).length<10)return w("Telefone deve ter DDD e pelo menos 8 digitos.",h(E),E)}if(s===6){const l=m("feature-register-sus"),E=re(l);if(!E)return w("Informe o numero do Cartao SUS.",h(l),l);if(E.length!==15)return w("Cartao SUS deve ter 15 digitos.",h(l),l)}return s===7&&!Aa()?w("Confirme a autorizacao para uso dos dados anonimizados.",t.querySelector("[data-register-consent]")):s===8&&ye<1?w("Adicione ao menos uma imagem do termo.",t.querySelector(".register-upload-grid")):s===9&&!we?w("Conclua os antecedentes clinicos do paciente.",t.querySelector("[data-register-history]")):{valid:!0,page:t}}function ze(e=L){return ne(e).valid}function Z(){if(!k)return;const e=ze();k.classList.toggle("has-value",e),k.classList.toggle("needs-value",!e),k.setAttribute("aria-disabled",String(!e)),k.disabled=!1}function Te(e=ne(),t={}){var l;if(!e||e.valid){Ce((e==null?void 0:e.page)||O());return}const{page:s,message:u,input:v}=e,m=e.target||(s==null?void 0:s.querySelector("[data-register-input-frame], .register-options, .register-consent-box, .register-upload-grid, .register-history-card"));if(!m)return;const h=Sa(s);s==null||s.classList.add("has-validation-error"),m.classList.add("has-error"),t.shake!==!1&&(m.classList.remove("is-empty-shake"),m.offsetWidth,m.classList.add("is-empty-shake")),h&&(h.hidden=!1,h.replaceChildren(document.createTextNode(u)));const w=v||((l=m.querySelector)==null?void 0:l.call(m,"[data-register-input]"));if(w){w.setAttribute("aria-invalid","true"),h&&w.setAttribute("aria-describedby",h.id),t.focus!==!1&&w.focus({preventScroll:!0});return}t.focus!==!1&&typeof m.focus=="function"&&m.focus({preventScroll:!0})}function La(){Te(ne())}function ae(e=O()){if(!(e!=null&&e.classList.contains("has-validation-error")))return;const t=ne(Number(e.dataset.registerPage));if(t.valid){Ce(e);return}Te(t,{shake:!1,focus:!1})}function oe(e,t={}){var h;if(!x.length)return;const s=Math.min(Math.max(Number(e),1),W);if(!Number.isFinite(s))return;const u=s<L||t.source==="back";L=s,d==null||d.setAttribute("data-register-direction",u?"back":"forward"),x.forEach(w=>{const l=Number(w.dataset.registerPage)===L;w.classList.toggle("is-active",l),w.setAttribute("aria-hidden",String(!l))});const v=O(),m=(v==null?void 0:v.dataset.registerKeyboard)==="true";if(d==null||d.classList.toggle("has-keyboard",m),A==null||A.classList.toggle("is-first",L===1),A==null||A.classList.toggle("is-final",L===W),M&&(M.style.width=`${L/W*100}%`),le(F,`Passo ${L} de ${W}`),k){const w=L===W?"Concluir":"Próximo";(h=k.querySelector("span"))==null||h.replaceChildren(document.createTextNode(w))}U=(v==null?void 0:v.querySelector("[data-register-input]"))||U,m&&t.source!=="demo"?($=!0,window.requestAnimationFrame(()=>ce(U))):$=!1,Z()}function Ee(){if(j(),!ze()){La();return}if(L<W){oe(L+1,{source:"next"});return}if(!x.length){I(X());return}I(X())}function Pa(){j(),L>1&&oe(L-1,{source:"back"})}function qe(e,t=e.length){const s=H();if(!s)return;s.value=e,je(s),s.dispatchEvent(new Event("input",{bubbles:!0})),s.focus({preventScroll:!0});const u=Math.min(t,s.value.length);s.setSelectionRange(u,u)}function Fa(e,t){return!e||t.length!==1?!1:e.inputMode==="numeric"?/\d/.test(t):!0}function ie(e){const t=H();if(!t||!e)return;const s=t.selectionStart??t.value.length,u=t.selectionEnd??t.value.length,v=`${t.value.slice(0,s)}${e}${t.value.slice(u)}`;qe(v.slice(0,t.maxLength||80),s+e.length)}function Re(){const e=H();if(!e)return;const t=e.selectionStart??e.value.length,s=e.selectionEnd??e.value.length;if(t!==s){qe(`${e.value.slice(0,t)}${e.value.slice(s)}`,t);return}t<=0||qe(`${e.value.slice(0,t-1)}${e.value.slice(s)}`,t-1)}function Ma(e){const t=H();if(!t)return e;if(t.inputMode==="numeric")return"";const s=t.selectionStart??t.value.length,u=t.value.slice(0,s);return u.length===0||/\s$/.test(u)?e.toUpperCase():e}function Ba(e){var u;if(!Q||!H())return;const t=e.target.closest(".keyboard-row span, .keyboard-row strong, .keyboard-row i");if(!t||!Q.contains(t))return;if(e.preventDefault(),e.stopPropagation(),j(),t.classList.contains("keyboard-enter")){Ee();return}if(t.classList.contains("keyboard-delete")){Re();return}if(t.classList.contains("keyboard-space")){ie(" ");return}if(t.classList.contains("keyboard-dot")){ie(".");return}if(t.classList.contains("keyboard-shift")||t.classList.contains("keyboard-emoji")||t.classList.contains("keyboard-globe")){(u=H())==null||u.focus({preventScroll:!0});return}const s=t.textContent.trim();/^[a-z]$/i.test(s)&&ie(Ma(s.toLowerCase()))}function ce(e){e&&(j(),$=!0,U=e,e.focus({preventScroll:!0}),window.requestAnimationFrame(()=>{var s;e.focus({preventScroll:!0});const t=e.value.length;try{(s=e.setSelectionRange)==null||s.call(e,t,t)}catch{}}))}function He(e){ce(e.querySelector("[data-register-input]")||U)}if(d==null||d.addEventListener("pointerdown",e=>{e.target.closest("button, [data-register-input], .register-keyboard")||ce(H())}),y.forEach(e=>{e.addEventListener("pointerdown",t=>{t.stopPropagation(),He(e)}),e.addEventListener("click",t=>{t.stopPropagation(),He(e)})}),q.forEach(e=>{["pointerdown","mousedown","touchstart","pointerup","click"].forEach(t=>{e.addEventListener(t,s=>{s.stopPropagation(),ce(e)})}),["keydown","keyup"].forEach(t=>{e.addEventListener(t,s=>{s.stopPropagation()})}),e.addEventListener("focus",()=>{U=e,$=!0,j()}),e.addEventListener("input",()=>{je(e),Z(),ae(e.closest("[data-register-page]"))})}),document.addEventListener("keydown",e=>{if(!$||D!==1)return;const t=H(),s=O();if(!(!t||!(s!=null&&s.contains(t)))&&document.activeElement!==t&&!(e.ctrlKey||e.metaKey||e.altKey)){if(e.key==="Enter"){e.preventDefault(),Ee();return}if(e.key==="Backspace"){e.preventDefault(),Re();return}Fa(t,e.key)&&(e.preventDefault(),ie(e.key))}}),k==null||k.addEventListener("click",Ee),B==null||B.addEventListener("click",Pa),Q==null||Q.addEventListener("click",Ba),ue==null||ue.addEventListener("click",()=>{var e;j(),q.forEach(t=>{t.value=""}),ye=0,we=!1,pe.forEach(t=>{var s;t.classList.remove("is-selected"),t.setAttribute("aria-pressed","false"),(s=t.querySelector("span"))==null||s.replaceChildren(document.createTextNode("Adicionar"),document.createElement("br"),document.createTextNode("imagem"))}),S==null||S.classList.remove("is-selected"),S==null||S.setAttribute("aria-pressed","false"),(e=S==null?void 0:S.querySelector("strong"))==null||e.replaceChildren(document.createTextNode("0/6 etapas")),a.querySelectorAll("[data-register-choice], [data-register-consent]").forEach(t=>{t.classList.remove("is-selected"),t.setAttribute("aria-pressed","false")}),Da(),oe(1,{source:"clear"})}),a.querySelectorAll("[data-register-choice]").forEach(e=>{e.addEventListener("click",()=>{j();const t=e.dataset.registerChoice;a.querySelectorAll(`[data-register-choice="${t}"]`).forEach(s=>{s.classList.toggle("is-selected",s===e),s.setAttribute("aria-pressed",String(s===e))}),Z(),ae(e.closest("[data-register-page]"))})}),(Ue=a.querySelector("[data-register-consent]"))==null||Ue.addEventListener("click",e=>{j();const t=e.currentTarget,s=!t.classList.contains("is-selected");t.classList.toggle("is-selected",s),t.setAttribute("aria-pressed",String(s)),Z(),ae(t.closest("[data-register-page]"))}),pe.forEach(e=>{e.addEventListener("click",()=>{var t;j(),e.classList.contains("is-selected")||(e.classList.add("is-selected"),e.setAttribute("aria-pressed","true"),(t=e.querySelector("span"))==null||t.replaceChildren(document.createTextNode("Imagem"),document.createElement("br"),document.createTextNode("adicionada"))),ye=pe.filter(s=>s.classList.contains("is-selected")).length,Z(),ae(e.closest("[data-register-page]"))})}),S==null||S.addEventListener("click",()=>{var e;j(),we=!0,S.classList.add("is-selected"),S.setAttribute("aria-pressed","true"),(e=S.querySelector("strong"))==null||e.replaceChildren(document.createTextNode("6/6 etapas")),Z(),ae(S.closest("[data-register-page]"))}),V==null||V.addEventListener("click",ba),ge==null||ge.addEventListener("click",va),_e==null||_e.addEventListener("click",xa),ta.forEach(e=>{e.addEventListener("click",()=>{Ie()})}),sa.forEach(e=>{e.addEventListener("click",()=>{ee()})}),ra.forEach(e=>{e.addEventListener("click",()=>{N("camera")})}),na.forEach(e=>{e.addEventListener("click",()=>{N("gallery")})}),oa.forEach(e=>{e.addEventListener("click",()=>{N("camera-captured")})}),ia.forEach(e=>{e.addEventListener("click",ya)}),ca.forEach(e=>{e.addEventListener("click",()=>{const t=!e.classList.contains("is-selected");e.classList.toggle("is-selected",t),e.setAttribute("aria-pressed",String(t))})}),la.forEach(e=>{e.addEventListener("click",()=>{if(!R){Ie();return}N("preview")})}),da.forEach(e=>{e.addEventListener("click",()=>{N("remove")})}),ua.forEach(e=>{e.addEventListener("click",wa)}),pa.forEach(e=>{e.addEventListener("click",()=>{N("preview")})}),ma.forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.featureImageTarget;t&&Be(t)})}),ga.forEach(e=>{e.addEventListener("click",()=>{const t=!e.classList.contains("is-selected");e.classList.toggle("is-selected",t),e.setAttribute("aria-pressed",String(t))})}),fe.forEach(e=>{e.addEventListener("click",()=>{const t=e.classList.contains("is-selected");fe.forEach(s=>{s.classList.remove("is-selected"),s.setAttribute("aria-expanded","false")}),e.classList.toggle("is-selected",!t),e.setAttribute("aria-expanded",String(!t))})}),oe(1,{source:"init"}),J(1,{source:"init"}),n.forEach((e,t)=>{e.addEventListener("click",()=>{I(Number(e.dataset.step))}),e.addEventListener("keydown",s=>{var m,h;const u=s.key;if(!["ArrowRight","ArrowDown","ArrowLeft","ArrowUp","Home","End"].includes(u))return;s.preventDefault();let v=t;(u==="ArrowRight"||u==="ArrowDown")&&(v=(t+1)%n.length),(u==="ArrowLeft"||u==="ArrowUp")&&(v=(t-1+n.length)%n.length),u==="Home"&&(v=0),u==="End"&&(v=n.length-1),(m=n[v])==null||m.focus(),I(Number((h=n[v])==null?void 0:h.dataset.step))})}),p.forEach(e=>{e.addEventListener("click",()=>{I(Number(e.dataset.step))})}),g==null||g.addEventListener("click",()=>{I(Me())}),o==null||o.addEventListener("click",()=>{I(X())}),b){let e=0,t=0,s=!1;b.addEventListener("pointerdown",u=>{var v;u.button===0&&(u.target.closest("input, button, .register-keyboard, .lesion-image-flow")||(s=!0,e=u.clientX,t=u.clientY,(v=b.setPointerCapture)==null||v.call(b,u.pointerId)))}),b.addEventListener("pointerup",u=>{if(!s)return;s=!1;const v=u.clientX-e,m=u.clientY-t;Math.abs(v)<46||Math.abs(v)<Math.abs(m)||I(v<0?X():Me())}),b.addEventListener("pointercancel",()=>{s=!1})}a.classList.add("is-paused"),"IntersectionObserver"in window?new IntersectionObserver(([t])=>{a.classList.toggle("is-inview",t.isIntersecting)},{threshold:.24,rootMargin:"-8% 0px -8% 0px"}).observe(a):a.classList.add("is-inview"),document.addEventListener("dermalert:langchange",e=>{var t;ke(((t=e.detail)==null?void 0:t.lang)||Oe())}),ke(),I(K)}function Qa(r=document){const a=r.querySelector("#faq");if(!a||a.dataset.faqWired==="true")return;a.dataset.faqWired="true";const i=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=[a.querySelector("#faq-title"),a.querySelector("#faq-sub")];if(c.forEach((o,f)=>{o&&(o.style.opacity="0",o.style.transform="translateY(16px)",o.style.transition=`opacity 600ms ease ${f*80}ms, transform 600ms ease ${f*80}ms`)}),"IntersectionObserver"in window&&!i){const o=new IntersectionObserver(f=>{f.forEach(b=>{b.isIntersecting&&(b.target.style.opacity="1",b.target.style.transform="translateY(0)",o.unobserve(b.target))})},{threshold:.2});c.forEach(f=>f&&o.observe(f))}else c.forEach(o=>{o&&(o.style.opacity="1",o.style.transform="translateY(0)")});const n=Array.from(a.querySelectorAll(".faq-item"));function p(o,f,b,d,x){x?(o.classList.add("bg-[#2F488A]","text-white"),o.classList.remove("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),f.classList.add("bg-[#2F488A]","text-white/95"),f.classList.remove("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),d&&(d.classList.remove("text-[#1D366F]","dark:text-white"),d.classList.add("text-white")),b.classList.remove("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"),b.classList.add("text-white","border-white/40")):(o.classList.remove("bg-[#2F488A]","text-white"),o.classList.add("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),f.classList.remove("bg-[#2F488A]","text-white/95"),f.classList.add("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),d&&(d.classList.remove("text-white"),d.classList.add("text-[#1D366F]","dark:text-white")),b.classList.remove("text-white","border-white/40"),b.classList.add("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"))}function _(o,f){const b=o.querySelector(".faq-trigger"),d=o.querySelector(".faq-panel"),x=o.querySelector(".faq-icon"),M=o.querySelector(".faq-title"),F=x==null?void 0:x.querySelector(".plus"),q=x==null?void 0:x.querySelector(".minus");if(o.classList.toggle("is-open",f),p(b,d,x,M,f),f){if(i)d.style.height="auto";else{d.style.overflow="hidden",d.style.height="auto";const y=d.scrollHeight;d.style.height="0px",requestAnimationFrame(()=>{d.style.transition="height 260ms ease",d.style.height=y+"px"}),setTimeout(()=>{d.style.transition="",d.style.height="auto",d.style.overflow=""},300)}F==null||F.classList.add("hidden"),q==null||q.classList.remove("hidden")}else{const y=d.scrollHeight;d.style.height=y+"px",d.style.overflow="hidden",requestAnimationFrame(()=>{d.style.transition=i?"":"height 220ms ease",d.style.height="0px"}),setTimeout(()=>{d.style.transition="",d.style.overflow=""},i?0:240),F==null||F.classList.remove("hidden"),q==null||q.classList.add("hidden")}}if(n.forEach((o,f)=>_(o,f===0)),n.forEach(o=>{o.querySelector(".faq-trigger").addEventListener("click",()=>{const b=!o.classList.contains("is-open");n.forEach(d=>d!==o&&_(d,!1)),_(o,b)})}),a.querySelector(".faq-cta")){const o="faqShimmer"+Math.random().toString(36).slice(2),f=document.createElement("style");f.textContent=`
      @keyframes ${o} {
