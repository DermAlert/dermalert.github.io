...
`,M=`<!-- HERO (sem margens extras top/bottom) -->\r
...
>
  <div class="max-w-[1200px] mx-auto px-6">
    ...
    <header class="text-center pre-anim" data-anim="rise-blur" style="--anim-delay:.05s">
      <h2
        id="about-title"
        class="title-anim text-[#2F488A] dark:text-white font-extrabold leading-tight text-[48px]"
    ...
    <div class="mt-8 relative">
      ...
      >
        <p
          class="font-semibold text-white text-[35px] leading-[40px]"
    ...
    >
      <p
        class="text-[#1D366F] font-normal text-[21px] leading-[32px]"
            ...
            <div class="mt-4 flex justify-center">\r
              <a href="#"\r
                 class="func-cta btn-shine inline-flex items-center justify-center px-5 py-2.5 rounded-full\r
                        bg-[#E8611D] text-white text-[14px] font-semibold uppercase shadow
      ...
      <div id="func-cards" class="grid grid-rows-3 gap-10 h-[915px] min-h-0">\r
        ...
        <article data-step="1" tabindex="0"\r
          ...
          <header class="flex items-center gap-4 justify-center">\r
            ...
            <h3 class="text-[#031E21] font-semibold text-[24px] md:text-[28px] leading-tight" data-i18n="features_step1_title">
              Cadastre o Paciente\r
            </h3>\r
          </header>\r
          ...
          <div class="mt-6 flex justify-center">\r
            <a href="#"\r
               class="func-cta btn-shine inline-flex items-center justify-center px-9 py-3.5 rounded-full\r
                      bg-[#E8611D] text-white text-[16px] font-semibold uppercase shadow hover:brightness-105 transition">
              <span data-i18n="features_step1_cta">Começar Agora</span>\r
            </a>\r
          </div>\r
        </article>\r
\r
        ...
        <article data-step="2" tabindex="0"\r
          ...
          <header class="flex items-center gap-4 justify-center">\r
            ...
            <h3 class="text-[#031E21] font-semibold text-[24px] md:text-[28px] leading-tight" data-i18n="features_step2_title">
              Anamnese e foto\r
            </h3>\r
          </header>\r
...
\r
        ...
        <article data-step="3" tabindex="0"\r
          ...
          <header class="flex items-center gap-4 justify-center">\r
            ...
            <h3 class="text-[#031E21] font-semibold text-[24px] md:text-[28px] leading-tight" data-i18n="features_step3_title">
              Triagem e pesquisa\r
            </h3>\r
          </header>\r
