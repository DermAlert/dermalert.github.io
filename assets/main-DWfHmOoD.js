(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))c(n);new MutationObserver(n=>{for(const u of n)if(u.type==="childList")for(const m of u.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&c(m)}).observe(document,{childList:!0,subtree:!0});function r(n){const u={};return n.integrity&&(u.integrity=n.integrity),n.referrerPolicy&&(u.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?u.credentials="include":n.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function c(n){if(n.ep)return;n.ep=!0;const u=r(n);fetch(n.href,u)}})();const pt=`<!-- HEADER fixo + spacer dinâmico -->\r
...
\r
    ...
    <nav class="da-nav hidden lg:flex items-center gap-1 text-sm font-medium text-white/90" aria-label="Principal">
      ...
      <a href="/ajuda-e-suporte/documentacao-tecnica/frontend.html" class="da-nav-link"><span data-i18n="documentacao">Documentação</span></a>
\r
...
\r
          ...
          <li>\r
            <a class="flex items-center gap-3 px-5 py-3 hover:bg-white/10 active:bg-white/15" href="/ajuda-e-suporte/documentacao-tecnica/frontend.html">
...
\r
        ...
        <div class="px-5 pb-3 grid grid-cols-2 gap-3">\r
          ...
          <a href="/ajuda-e-suporte/documentacao-gces/release-1.html" class="rounded-xl bg-white/10 hover:bg-white/15 py-3 px-4 text-sm" data-i18n="lancamentos">Lançamentos</a>
        </div>\r
\r
        <!-- Preferências -->\r
...
`,mt=`<section id="hero" class="relative w-full overflow-hidden text-white">
...
`,ft=`<!-- PARTNERS / APOIO E INICIATIVA -->\r
<section id="partners" class="w-full">
  <div class="w-full max-w-[1358px] mx-auto px-5 sm:px-6 lg:px-10">\r
...
`,ht=`<section id="functionalities" class="dermalert-feature-flow" aria-labelledby="feature-flow-title">
  ...
  <div class="feature-flow-inner">
    ...
    <div class="feature-flow-stage" data-feature-flow>
      ...
      <div class="feature-flow-panel">
        <div class="feature-interaction-guide" aria-label="Dica de interacao">
          <span class="feature-guide-person" aria-hidden="true">
            <i></i>
          </span>
          <span class="feature-guide-copy">
            <strong>Explore no seu ritmo</strong>
            <small>Use as setas ou clique nos cards. Dentro do celular, toque nos botoes, campos e opcoes para testar o fluxo.</small>
          </span>
        </div>

        <div class="flow-controls" role="group" aria-label="Navegacao manual da demonstracao">
          ...
          <button class="flow-icon-btn" type="button" data-flow-next aria-label="Proxima etapa" title="Proxima etapa">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
`,bt=`<section id="who-for" class="who-section">
...
</section>`,vt=`<section id="faq" class="w-full py-14 bg-[#F5F9FF] dark:bg-transparent">
  <div class="max-w-[1200px] xl:max-w-[1358px] mx-auto px-6">
    ...
    <div class="mt-10 md:mt-12 flex justify-center">
      <a href="/ajuda-e-suporte/problemas-comuns.html"
...
`,yt=`<!-- ===== FOOTER (full-bleed + i18n + theme-aware) ===== -->
<!-- OBS: este arquivo é injetado dentro de #app-footer pelo main.js -->
<div class="da-footer-content">
  <div class="da-footer-brand">
    <a href="index.html" class="da-footer-logo-link" aria-label="DermAlert">
      <img src="logo-dermalert.png" alt="DermAlert" class="da-footer-logo da-footer-logo--color" />
      <img src="logo.png" alt="DermAlert" class="da-footer-logo da-footer-logo--white" />
    </a>
    <p class="da-footer-tagline" data-i18n="hero_sub">
      Registre paciente, conduza anamnese e organize dados para decisões clínicas e pesquisa.
    </p>
  </div>

  <div class="da-footer-divider"></div>

  <div class="da-footer-grid">
    <div class="da-footer-column">
      <h4 class="da-footer-heading" data-i18n="footer_col_funciona">COMO FUNCIONA</h4>
      <ul class="da-footer-list">
        <li><a href="comofunciona.html" class="da-footer-link" data-i18n="footer_link_passo">Passo a Passo</a></li>
        <li><a href="curso.html" class="da-footer-link" data-i18n="footer_link_material">Material Educativo</a></li>
        <li><a href="index.html#app-features-base" class="da-footer-link" data-i18n="footer_link_funcionalidades">Funcionalidades</a></li>
      </ul>
    </div>

    <div class="da-footer-column">
      <h4 class="da-footer-heading" data-i18n="footer_col_ajuda">AJUDA E SUPORTE</h4>
      <ul class="da-footer-list">
        <li><a href="suporte.html" class="da-footer-link" data-i18n="footer_link_obter_acesso">Obter Acesso</a></li>
        <li><a href="privacidade.html#exclusao-dados" class="da-footer-link" data-i18n="footer_link_remover_dados">Remover Dados</a></li>
        <li><a href="index.html#app-faq" class="da-footer-link" data-i18n="footer_link_faq">Perguntas Frequentes</a></li>
      </ul>
    </div>

    <div class="da-footer-column">
      <h4 class="da-footer-heading" data-i18n="footer_col_docs">DOCUMENTAÇÃO</h4>
      <ul class="da-footer-list">
        <li><a href="sobre.html" class="da-footer-link" data-i18n="footer_link_sobre_projeto">Sobre o Projeto</a></li>
        <li><a href="sobre.html" class="da-footer-link" data-i18n="footer_link_quem_somos">Quem Somos</a></li>
        <li><a href="index.html#app-partners" class="da-footer-link" data-i18n="footer_link_apoiadores">Apoiadores</a></li>
      </ul>
    </div>

    <div class="da-footer-column">
      <h4 class="da-footer-heading" data-i18n="footer_col_curso">CURSO DE EXTENSÃO</h4>
      <ul class="da-footer-list">
        <li><a href="curso.html" class="da-footer-link" data-i18n="footer_link_sobre_curso">Sobre o Curso</a></li>
        <li><a href="comofunciona.html" class="da-footer-link" data-i18n="footer_link_como_funciona_curso">Como Funciona</a></li>
        <li><a href="/curso-de-extensao/sobre-o-curso.html" class="da-footer-link" data-i18n="footer_link_inscricao">Inscrição</a></li>
      </ul>
    </div>

    <div class="da-footer-column">
      <h4 class="da-footer-heading" data-i18n="footer_col_sobre">SOBRE</h4>
      <ul class="da-footer-list">
        <li><a href="privacidade.html" class="da-footer-link" data-i18n="politica_privacidade">Política de Privacidade</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="da-footer-bottom">
    <div>
      <h4 class="da-footer-heading" data-i18n="footer_contact">CONTATO</h4>
      <p class="da-footer-contact">
        <a href="mailto:caguiar@unb.br" class="da-footer-link">caguiar@unb.br</a>
      </p>
    </div>

    <div>
      <h4 class="da-footer-heading" data-i18n="footer_social">REDES SOCIAIS</h4>
      <div class="da-footer-socials">
        <a href="https://github.com/DermAlert" class="da-footer-social-link" aria-label="GitHub">
        ...
        <a href="https://www.instagram.com/DermAlert" class="da-footer-social-link" aria-label="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  <p class="da-footer-copyright" data-i18n="footer_copyright">
    DermAlert © 2025. Todos os direitos reservados.
  </p>
</div>`;function wt(){if(!document.getElementById("hero"))return;const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=document.getElementById("hero-title"),c=document.getElementById("hero-sub"),n=[r,c];function u(o,d=0){o&&(o.style.opacity="0",o.style.transform="translateY(16px) scale(.995)",o.style.transition=`opacity 600ms ease ${d}ms, transform 600ms ease ${d}ms`,o.style.willChange="opacity, transform")}function m(o){o&&(o.style.opacity="1",o.style.transform="translateY(0) scale(1)",setTimeout(()=>{o.style.willChange="auto"},700))}function p(o,d=1.02){if(!o)return;const h=o.style.transition?o.style.transition+", transform 220ms ease":"transform 220ms ease";o.style.transition=h;const g=()=>{a||(o.style.transform=`scale(${d})`,o.style.willChange="transform")},x=()=>{o.style.transform="scale(1)",o.style.willChange="auto"};o.addEventListener("pointerenter",g),o.addEventListener("pointerleave",x),o.addEventListener("focus",g),o.addEventListener("blur",x)}if(u(r,0),u(c,100),"IntersectionObserver"in window&&!a){const o=new IntersectionObserver(d=>{d.forEach(h=>{h.isIntersecting&&(m(h.target),o.unobserve(h.target))})},{threshold:.2});n.forEach(d=>d&&o.observe(d))}else n.forEach(m);p(r,1.02),p(c,1.015)}function xt(s=document){var k,A;const a=s.querySelector("#about-dermalert");if(!a||a.dataset.aboutWired==="true")return;a.dataset.aboutWired="true";const r=((k=window.matchMedia)==null?void 0:k.call(window,"(prefers-reduced-motion: reduce)").matches)??!1,c=((A=window.matchMedia)==null?void 0:A.call(window,"(hover: hover) and (pointer: fine)").matches)??!1,n=a.querySelector("#about-kicker"),u=a.querySelector("#about-title"),m=a.querySelector("#about-sub"),p=a.querySelector("#about-media"),o=a.querySelector("#about-img"),d=a.querySelector("#about-highlight"),h=a.querySelector("#about-note"),g=(_,C=0)=>{_&&(_.style.opacity="0",_.style.transform="translateY(16px) scale(.995)",_.style.transition=`opacity 700ms cubic-bezier(.22,.75,.25,1) ${C}ms, transform 700ms cubic-bezier(.22,.75,.25,1) ${C}ms`,_.style.willChange="opacity, transform")},x=_=>{_&&(_.classList.remove("pre-anim"),_.classList.add("is-inview"),_.style.opacity="1",_.style.transform="translateY(0) scale(1)",setTimeout(()=>{_.style.willChange="auto"},800))},P=[n,u,m,p,d,h];if(P.forEach((_,C)=>g(_,C*90)),!r&&"IntersectionObserver"in window){const _=new IntersectionObserver(C=>{C.forEach(j=>{j.isIntersecting&&(x(j.target),_.unobserve(j.target))})},{threshold:.22,rootMargin:"0px 0px -10% 0px"});P.forEach(C=>C&&_.observe(C))}else P.forEach(_=>_&&x(_));if(c&&p){const _=()=>{r||(p.style.transition="transform 220ms ease",p.style.transform="scale(1.02)",p.style.willChange="transform")},C=()=>{p.style.transform="scale(1)",p.style.willChange="auto"};p.addEventListener("pointerenter",_),p.addEventListener("pointerleave",C),p.addEventListener("focus",_,!0),p.addEventListener("blur",C,!0),o&&(o.setAttribute("draggable","false"),o.style.userSelect="none",o.style.pointerEvents="none")}}function kt(){const s=document.getElementById("features-pills");if(!s)return;const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,r=Array.from(s.querySelectorAll("li"));r.forEach((n,u)=>{n.style.opacity="0",n.style.transform="translateY(8px)",n.style.transition=`opacity 480ms ease ${u*60}ms, transform 480ms ease ${u*60}ms`;const m=n.style.transition?n.style.transition+", transform 160ms ease":"transform 160ms ease";n.style.transition=m;const p=()=>{a||(n.style.transform="translateY(-2px) scale(1.01)",n.style.willChange="transform")},o=()=>{n.style.transform="translateY(0) scale(1)",n.style.willChange="auto"};n.addEventListener("pointerenter",p),n.addEventListener("pointerleave",o),n.addEventListener("focusin",p),n.addEventListener("focusout",o)});const c=n=>{n.style.opacity="1",n.style.transform="translateY(0) scale(1)"};if("IntersectionObserver"in window&&!a){const n=new IntersectionObserver(u=>{u.forEach(m=>{m.isIntersecting&&(c(m.target),n.unobserve(m.target))})},{threshold:.15});r.forEach(u=>n.observe(u))}else r.forEach(c)}const Oe=5200,At=8800,Ct=7600,Et=9200,qt=820,St=950,Dt=1300,Ue=[1,2,3,4,5,6,7,8,9],Lt={1:"Ana Maria Souza",2:"12345678909",3:"14031986",5:"ana.souza@email.com",6:"898001160000001"},He=[{page:1,location:1,hasImages:!1},{page:2,hasImages:!1},{page:2,panel:"choice",hasImages:!1},{page:2,panel:"camera",hasImages:!1},{page:2,panel:"camera-captured",hasImages:!1},{page:2,hasImages:!0},{page:2,panel:"preview",hasImages:!0},{page:3,hasImages:!0}],he=["choice","camera","camera-captured","gallery","preview","remove"],ha={"pt-BR":{status_1:"Cadastro",status_2:"Lesão",status_3:"Triagem",play_label:"Reproduzir animação",pause_label:"Pausar animação",reduced_label:"Movimento reduzido ativo",screen1_kicker:"Novo atendimento",screen1_title:"Identificação segura",secure_chip:"Seguro",screen1_field_name:"Nome",screen1_field_birth:"Nascimento",screen1_field_card:"Cartão SUS",screen1_field_unit:"Unidade",screen1_field_consent:"Consentimento",screen1_consent_ok:"Registrado",screen1_field_sync:"Sincronização",screen1_sync_ready:"Pronta",screen1_action:"Salvar cadastro",screen2_kicker:"Etapa clínica",screen2_title:"Registrar lesão",screen2_question_label:"Sinais observados",screen2_chip_a:"Assimetria",screen2_chip_b:"Bordas",screen2_chip_c:"Cor",screen2_chip_d:"Evolução",screen2_check1:"Perguntas guiadas completas",screen2_check2:"Imagem clínica vinculada",screen2_action:"Enviar para triagem",screen3_kicker:"Resultado",screen3_title:"Triagem e pesquisa",screen3_badge:"OK",screen3_priority_label:"Prioridade",screen3_priority_value:"Avaliação médica",screen3_priority_note:"Caso organizado para encaminhamento.",screen3_check1:"Histórico clínico salvo",screen3_check2:"Dados prontos para análise",screen3_check3:"Encaminhamento rastreável",screen3_action:"Concluir atendimento",metric_steps:"etapas guiadas",metric_privacy:"dados sensíveis protegidos",metric_referral:"encaminhamento rastreável"},en:{status_1:"Registration",status_2:"Lesion",status_3:"Triage",play_label:"Play animation",pause_label:"Pause animation",reduced_label:"Reduced motion is active",screen1_kicker:"New visit",screen1_title:"Secure identification",secure_chip:"Secure",screen1_field_name:"Name",screen1_field_birth:"Birth date",screen1_field_card:"Health ID",screen1_field_unit:"Unit",screen1_field_consent:"Consent",screen1_consent_ok:"Recorded",screen1_field_sync:"Sync",screen1_sync_ready:"Ready",screen1_action:"Save registration",screen2_kicker:"Clinical step",screen2_title:"Register lesion",screen2_question_label:"Observed signs",screen2_chip_a:"Asymmetry",screen2_chip_b:"Borders",screen2_chip_c:"Color",screen2_chip_d:"Evolution",screen2_check1:"Guided questions complete",screen2_check2:"Clinical image linked",screen2_action:"Send to triage",screen3_kicker:"Result",screen3_title:"Triage & research",screen3_badge:"OK",screen3_priority_label:"Priority",screen3_priority_value:"Medical review",screen3_priority_note:"Case organized for referral.",screen3_check1:"Clinical history saved",screen3_check2:"Data ready for analysis",screen3_check3:"Traceable referral",screen3_action:"Finish visit",metric_steps:"guided steps",metric_privacy:"sensitive data protected",metric_referral:"traceable referral"},es:{status_1:"Registro",status_2:"Lesión",status_3:"Triaje",play_label:"Reproducir animación",pause_label:"Pausar animación",reduced_label:"Movimiento reducido activo",screen1_kicker:"Nueva atención",screen1_title:"Identificación segura",secure_chip:"Seguro",screen1_field_name:"Nombre",screen1_field_birth:"Nacimiento",screen1_field_card:"Tarjeta de salud",screen1_field_unit:"Unidad",screen1_field_consent:"Consentimiento",screen1_consent_ok:"Registrado",screen1_field_sync:"Sincronización",screen1_sync_ready:"Lista",screen1_action:"Guardar registro",screen2_kicker:"Etapa clínica",screen2_title:"Registrar lesión",screen2_question_label:"Signos observados",screen2_chip_a:"Asimetría",screen2_chip_b:"Bordes",screen2_chip_c:"Color",screen2_chip_d:"Evolución",screen2_check1:"Preguntas guiadas completas",screen2_check2:"Imagen clínica vinculada",screen2_action:"Enviar a triaje",screen3_kicker:"Resultado",screen3_title:"Triaje e investigación",screen3_badge:"OK",screen3_priority_label:"Prioridad",screen3_priority_value:"Evaluación médica",screen3_priority_note:"Caso organizado para derivación.",screen3_check1:"Historial clínico guardado",screen3_check2:"Datos listos para análisis",screen3_check3:"Derivación rastreable",screen3_action:"Concluir atención",metric_steps:"etapas guiadas",metric_privacy:"datos sensibles protegidos",metric_referral:"derivación rastreable"}};function Ne(){const s=localStorage.getItem("lang");if(s)return s;const a=document.documentElement.lang||"pt-BR";return a.toLowerCase().startsWith("pt")?"pt-BR":a}function ba(s){return ha[s]||ha["pt-BR"]}function be(s,a){!s||typeof a!="string"||s.textContent===a||(s.textContent=a)}function Pt(s=document){var _a;const a=s.querySelector("#functionalities");if(!a||a.dataset.featuresBaseWired==="true")return;a.dataset.featuresBaseWired="true";const r=a.querySelector("[data-feature-flow]")||a,c=Array.from(a.querySelectorAll("[data-flow-screen]")),n=Array.from(a.querySelectorAll("[data-flow-card]")),u=Array.from(a.querySelectorAll("[data-flow-step-button]")),m=a.querySelector("[data-flow-status]"),p=a.querySelector("[data-flow-prev]"),o=a.querySelector("[data-flow-next]"),d=a.querySelector("[data-flow-play]"),h=a.querySelector("[data-play-icon]"),g=a.querySelector("[data-pause-icon]"),x=a.querySelector("[data-flow-progress-bar]"),P=Array.from(a.querySelectorAll(".flow-card-meter span")),k=a.querySelector("[data-flow-swipe]"),A=a.querySelector(".register-screen"),_=Array.from(a.querySelectorAll("[data-register-page]")),C=a.querySelector(".register-progress span"),j=a.querySelector(".register-step"),y=Array.from(a.querySelectorAll("[data-register-input]")),La=Array.from(a.querySelectorAll("[data-register-input-frame]")),O=a.querySelector("[data-register-next]"),V=a.querySelector("[data-register-back]"),G=a.querySelector("[data-register-actions]"),ae=a.querySelector(".register-keyboard[data-register-keyboard]"),ye=a.querySelector("[data-register-clear]"),b=a.querySelector(".lesion-screen"),te=Array.from(a.querySelectorAll("[data-lesion-page]")),Ge=a.querySelector("[data-lesion-progress]"),Pa=a.querySelector("[data-lesion-step-label]"),$=a.querySelector("[data-lesion-next]"),W=a.querySelector("[data-lesion-back]"),Z=a.querySelector("[data-lesion-actions]"),we=a.querySelector("[data-lesion-clear]"),de=a.querySelector("[data-lesion-upload-grid]"),Ia=Array.from(a.querySelectorAll("[data-lesion-add-image]")),ue=Array.from(a.querySelectorAll("[data-lesion-location]")),z=a.querySelector("[data-lesion-image-flow]"),$e=Array.from(a.querySelectorAll("[data-lesion-image-panel]")),Fa=Array.from(a.querySelectorAll("[data-lesion-image-close]")),Ma=Array.from(a.querySelectorAll("[data-lesion-open-camera]")),Ba=Array.from(a.querySelectorAll("[data-lesion-open-gallery]")),za=Array.from(a.querySelectorAll("[data-lesion-capture-image]")),Ta=Array.from(a.querySelectorAll("[data-lesion-use-image]")),Ra=Array.from(a.querySelectorAll("[data-lesion-gallery-item]")),ja=Array.from(a.querySelectorAll("[data-lesion-preview-image]")),Oa=Array.from(a.querySelectorAll("[data-lesion-delete-image]")),Ua=Array.from(a.querySelectorAll("[data-lesion-remove-confirm]")),Ha=Array.from(a.querySelectorAll("[data-lesion-remove-cancel]")),xe=a.querySelector("[data-feature-image-demo]"),We=Array.from(a.querySelectorAll("[data-feature-image-panel]")),Na=Array.from(a.querySelectorAll("[data-feature-image-target]")),Va=Array.from(a.querySelectorAll("[data-feature-gallery-item]")),Ga=Array.from(a.querySelectorAll("[data-feature-image-dot]"));if(!c.length||!n.length)return;const I=window.matchMedia("(prefers-reduced-motion: reduce)").matches,ke=c.map(e=>Number(e.dataset.flowScreen)).filter(e=>Number.isFinite(e)),se=Math.min(...ke),Ae=Math.max(...ke);let w=se,Ze=null,pe=!("IntersectionObserver"in window),Ye=!1,M=!1,E=1,S=1,B=!1,L=y[0]||null,Ce=null,Ee=null,ne=0,oe=0,Y=0,qe=null,Se=null,me=0,De=0,Q=0,Qe=Oe;const X=_.length||1,Le=te.length||1,Xe=8;function Pe(){return M&&pe&&!Ye}function Ke(){return w===1?At:w===2?Ct:w===3?Et:Oe}function ie(e=w){return e>=Ae?se:e+1}function Je(e=w){return e<=se?Ae:e-1}function $a(){const e=n.find(t=>Number(t.dataset.step)===w);return(e==null?void 0:e.querySelector(".flow-card-meter span"))||null}function ea(e=Q){Q=Math.max(0,Math.min(1,Number(e)||0));const t=`${(Q*100).toFixed(3)}%`,i=$a();x&&(x.style.width=t),P.forEach(l=>{l.style.width=l===i?t:"0%"})}function aa(){Se&&window.cancelAnimationFrame(Se),Se=null}function Wa(e=window.performance.now()){if(!me)return Q;const t=Math.max(1,Qe),i=Math.max(0,e-me);return Math.min(1,De+i/t*(1-De))}function Za(){ea(Wa()),aa(),me=0}function Ya(e=0){aa(),me=0,De=e,Q=e,Qe=Ke(),ea(Q)}function Ie(){if(!d)return;const e=ba(Ne()),t=I?e.reduced_label:M?e.pause_label:e.play_label;d.setAttribute("aria-label",t),d.setAttribute("title",t),d.setAttribute("aria-pressed",String(M&&!I)),d.disabled=I,h&&(h.hidden=M||I),g&&(g.hidden=!M||I)}function Fe(e){if(!xe||!We.length)return;const t=e==="camera-captured"?"camera":e;xe.classList.toggle("is-camera-captured",e==="camera-captured"),xe.dataset.imageState=e,We.forEach(l=>{const f=l.dataset.featureImagePanel===t;l.classList.toggle("is-active",f),l.setAttribute("aria-hidden",String(!f))}),Ga.forEach(l=>{l.classList.toggle("is-active",l.dataset.featureImageDot===e)});const i=he.indexOf(e);i>=0&&(Y=i)}function ta(){clearTimeout(qe),qe=null}function sa(){clearTimeout(Ce),Ce=null}function na(){clearTimeout(Ee),Ee=null}function oa(e){B=!!e,b==null||b.classList.toggle("has-images",B),_e()}function Qa(){const e=a.querySelector('[data-register-choice="gender"]');e&&a.querySelectorAll('[data-register-choice="gender"]').forEach(t=>{const i=t===e;t.classList.toggle("is-selected",i),t.setAttribute("aria-pressed",String(i))})}function Xa(){const e=a.querySelector("[data-register-consent]");e&&(e.classList.add("is-selected"),e.setAttribute("aria-pressed","true"))}function ia(e){if(!_.length)return;ce(e,{source:"demo"});const t=N(),i=Lt[e];t&&typeof i=="string"&&(t.value=i,Te(t),L=t),e===4&&Qa(),e===7&&Xa(),re()}function ra(e=!1){sa(),e&&(ne=0,ia(Ue[ne])),!(I||w!==1||!Pe()||!_.length)&&(Ce=window.setTimeout(()=>{ne=(ne+1)%Ue.length,ia(Ue[ne]),ra()},qt))}function Ka(e=0){ue.forEach((t,i)=>{const l=i===e;t.classList.toggle("is-selected",l),t.setAttribute("aria-expanded",String(l))})}function ca(e){!te.length||!e||("hasImages"in e&&oa(e.hasImages),K(e.page||1,{source:"demo"}),Number.isInteger(e.location)&&Ka(e.location),e.panel?H(e.panel):J(),"hasImages"in e&&oa(e.hasImages))}function la(e=!1){na(),e&&(oe=0,ca(He[oe])),!(I||w!==2||!Pe()||!te.length)&&(Ee=window.setTimeout(()=>{oe=(oe+1)%He.length,ca(He[oe]),la()},St))}function Ja(e=!1){w===1?ra(e):sa(),w===2?la(e):na()}function Me(e=!1){ta(),e&&(Y=0,Fe(he[Y])),!(I||w!==3||!Pe())&&(qe=window.setTimeout(()=>{Y=(Y+1)%he.length,Fe(he[Y]),Me()},Dt))}function da(){!I&&M&&ge(!1)}function Be(e=!1){clearTimeout(Ze),Ze=null,M=!1,a.classList.remove("is-playing"),a.classList.add("is-paused"),Za(),Ja(!1),Me(!1)}function ze(e=Ne()){const t=ba(e);a.querySelectorAll("[data-flow-i18n]").forEach(i=>{const l=i.getAttribute("data-flow-i18n");be(i,t[l])}),be(m,t[`status_${w}`]),Ie()}function T(e,t={}){if(!ke.includes(Number(e)))return;const i=Number(e),l=w,f=w===Ae&&i===se,F=i>w||f;r.dataset.direction=F?"forward":"back",w=i,a.style.setProperty("--flow-duration",`${Ke()}ms`),Ya(0),w!==2&&J(),l!==3&&w===3?Me(!0):w!==3&&ta(),c.forEach(v=>{const q=Number(v.dataset.flowScreen)===w;v.classList.toggle("is-active",q),v.setAttribute("aria-hidden",String(!q))}),n.forEach(v=>{const q=Number(v.dataset.step)===w;v.classList.toggle("is-active",q),v.setAttribute("aria-selected",String(q))}),u.forEach(v=>{v.classList.toggle("is-active",Number(v.dataset.step)===w)}),ze(),Be(t.source!=="init")}function ge(e){I||(M=!!e,Ie(),Be(!1))}function U(){!I&&M&&ge(!1)}function D(){!I&&M&&ge(!1)}function _e(){if(!$)return;const e=S===1||S===2&&B;$.classList.toggle("has-value",e),$.disabled=S===2&&!B}function et(){de&&(de.classList.remove("is-empty-shake"),de.offsetWidth,de.classList.add("is-empty-shake"))}function K(e,t={}){if(!te.length)return;const i=Math.min(Math.max(Number(e),1),Le);if(!Number.isFinite(i))return;const l=i<S||t.source==="back";S=i,b==null||b.setAttribute("data-lesion-direction",l?"back":"forward"),te.forEach(v=>{const q=Number(v.dataset.lesionPage)===S;v.classList.toggle("is-active",q),v.setAttribute("aria-hidden",String(!q))});const f=S===Le,F=Math.min(S,2);if(b==null||b.classList.toggle("is-complete",f),b==null||b.classList.toggle("has-images",B),Z==null||Z.classList.toggle("is-first",S===1),Z==null||Z.classList.toggle("is-final",S===2),W){const v=S===1||f;W.hidden=v,W.disabled=v}Ge&&(Ge.style.width=`${F/Xe*100}%`),be(Pa,`Passo ${F} de ${Xe}`),_e()}function at(){if(D(),S===1){K(2,{source:"next"});return}if(S===2){if(!B){et();return}K(3,{source:"next"});return}T(ie(),{source:"lesion-complete"})}function tt(){D(),S>1&&S<Le&&K(S-1,{source:"back"})}function H(e){if(!z||!$e.length)return;const t=e==="camera-captured"?"camera":e;z.classList.add("is-open"),z.classList.toggle("is-camera-captured",e==="camera-captured"),z.dataset.imageState=e,z.setAttribute("aria-hidden","false"),b==null||b.classList.add("is-image-flow-open"),$e.forEach(i=>{const l=i.dataset.lesionImagePanel===t;i.classList.toggle("is-active",l),i.setAttribute("aria-hidden",String(!l))})}function ua(){D(),H("choice")}function J(){z&&(z.classList.remove("is-open","is-camera-captured"),z.removeAttribute("data-image-state"),z.setAttribute("aria-hidden","true"),b==null||b.classList.remove("is-image-flow-open"))}function st(){D(),B=!0,b==null||b.classList.add("has-images"),J(),_e()}function nt(){D(),B=!1,b==null||b.classList.remove("has-images"),J(),_e()}function ot(){D(),B=!1,b==null||b.classList.remove("has-images"),J(),ue.forEach(e=>{e.classList.remove("is-selected"),e.setAttribute("aria-expanded","false")}),K(1,{source:"clear"})}function fe(){return _.find(e=>Number(e.dataset.registerPage)===E)||_[0]||null}function N(){const e=fe();return(e==null?void 0:e.querySelector("[data-register-input]"))||L||y[0]||null}function Te(e){if(!e)return;const t=e.value.replace(/\D/g,"");if(e.id==="feature-register-cpf"){e.value=t.slice(0,11).replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d)/,"$1.$2").replace(/(\d{3})(\d{1,2})$/,"$1-$2");return}if(e.id==="feature-register-birth"){e.value=t.slice(0,8).replace(/(\d{2})(\d)/,"$1/$2").replace(/(\d{2})(\d)/,"$1/$2");return}e.id==="feature-register-sus"&&(e.value=t.slice(0,15))}function it(e){return!!a.querySelector(`[data-register-choice="${e}"].is-selected`)}function pa(){return!!a.querySelector("[data-register-consent].is-selected")}function ma(){const e=fe(),t=e==null?void 0:e.querySelector("[data-register-input]");return t&&["1","2","3","6"].includes(e.dataset.registerPage)?t.value.trim().length>0:E===4?it("gender"):E===7?pa():!0}function re(){O&&(O.classList.toggle("has-value",ma()),O.disabled=E===7&&!pa())}function rt(){var f;const e=fe(),t=e==null?void 0:e.querySelector("[data-register-input-frame]"),i=e==null?void 0:e.querySelector(".register-options, .register-consent-box"),l=t||i;l&&(l.classList.remove("is-empty-shake"),l.offsetWidth,l.classList.add("is-empty-shake"),(f=N())==null||f.focus({preventScroll:!0}))}function ce(e,t={}){var v;if(!_.length)return;const i=Math.min(Math.max(Number(e),1),X);if(!Number.isFinite(i))return;const l=i<E||t.source==="back";E=i,A==null||A.setAttribute("data-register-direction",l?"back":"forward"),_.forEach(q=>{const fa=Number(q.dataset.registerPage)===E;q.classList.toggle("is-active",fa),q.setAttribute("aria-hidden",String(!fa))});const f=fe(),F=(f==null?void 0:f.dataset.registerKeyboard)==="true";if(A==null||A.classList.toggle("has-keyboard",F),G==null||G.classList.toggle("is-first",E===1),G==null||G.classList.toggle("is-final",E===X),V){const q=E===1;V.hidden=q,V.disabled=q}if(C&&(C.style.width=`${E/X*100}%`),be(j,`Passo ${E} de ${X}`),O){const q=E===X?"Concluir":"Próximo";(v=O.querySelector("span"))==null||v.replaceChildren(document.createTextNode(q))}L=(f==null?void 0:f.querySelector("[data-register-input]"))||L,F&&!["init","demo"].includes(t.source)&&(L==null||L.focus({preventScroll:!0})),re()}function ga(){if(U(),!ma()){rt();return}if(E<X){ce(E+1,{source:"next"});return}if(!_.length){T(ie(),{source:"register-next"});return}T(ie(),{source:"register-complete"})}function ct(){U(),E>1&&ce(E-1,{source:"back"})}function Re(e,t=e.length){const i=N();if(!i)return;i.value=e,Te(i),i.dispatchEvent(new Event("input",{bubbles:!0})),i.focus({preventScroll:!0});const l=Math.min(t,i.value.length);i.setSelectionRange(l,l)}function je(e){const t=N();if(!t||!e)return;const i=t.selectionStart??t.value.length,l=t.selectionEnd??t.value.length,f=`${t.value.slice(0,i)}${e}${t.value.slice(l)}`;Re(f.slice(0,t.maxLength||80),i+e.length)}function lt(){const e=N();if(!e)return;const t=e.selectionStart??e.value.length,i=e.selectionEnd??e.value.length;if(t!==i){Re(`${e.value.slice(0,t)}${e.value.slice(i)}`,t);return}t<=0||Re(`${e.value.slice(0,t-1)}${e.value.slice(i)}`,t-1)}function dt(e){const t=N();if(!t)return e;if(t.inputMode==="numeric")return"";const i=t.selectionStart??t.value.length,l=t.value.slice(0,i);return l.length===0||/\s$/.test(l)?e.toUpperCase():e}function ut(e){var l;if(!ae||!N())return;const t=e.target.closest(".keyboard-row span, .keyboard-row strong, .keyboard-row i");if(!t||!ae.contains(t))return;if(e.preventDefault(),e.stopPropagation(),U(),t.classList.contains("keyboard-enter")){ga();return}if(t.classList.contains("keyboard-delete")){lt();return}if(t.classList.contains("keyboard-space")){je(" ");return}if(t.classList.contains("keyboard-dot")){je(".");return}if(t.classList.contains("keyboard-shift")||t.classList.contains("keyboard-emoji")||t.classList.contains("keyboard-globe")){(l=N())==null||l.focus({preventScroll:!0});return}const i=t.textContent.trim();/^[a-z]$/i.test(i)&&je(dt(i.toLowerCase()))}if(La.forEach(e=>e.addEventListener("click",()=>{U(),L=e.querySelector("[data-register-input]")||L,L==null||L.focus({preventScroll:!0})})),y.forEach(e=>{e.addEventListener("focus",()=>{L=e,U()}),e.addEventListener("input",()=>{Te(e),re()})}),O==null||O.addEventListener("click",ga),V==null||V.addEventListener("click",ct),ae==null||ae.addEventListener("click",ut),ye==null||ye.addEventListener("click",()=>{U(),y.forEach(e=>{e.value=""}),a.querySelectorAll("[data-register-choice], [data-register-consent]").forEach(e=>{e.classList.remove("is-selected"),e.setAttribute("aria-pressed","false")}),ce(1,{source:"clear"})}),a.querySelectorAll("[data-register-choice]").forEach(e=>{e.addEventListener("click",()=>{U();const t=e.dataset.registerChoice;a.querySelectorAll(`[data-register-choice="${t}"]`).forEach(i=>{i.classList.toggle("is-selected",i===e),i.setAttribute("aria-pressed",String(i===e))}),re()})}),(_a=a.querySelector("[data-register-consent]"))==null||_a.addEventListener("click",e=>{U();const t=e.currentTarget,i=!t.classList.contains("is-selected");t.classList.toggle("is-selected",i),t.setAttribute("aria-pressed",String(i)),re()}),$==null||$.addEventListener("click",at),W==null||W.addEventListener("click",tt),we==null||we.addEventListener("click",ot),Ia.forEach(e=>{e.addEventListener("click",()=>{ua()})}),Fa.forEach(e=>{e.addEventListener("click",()=>{D(),J()})}),Ma.forEach(e=>{e.addEventListener("click",()=>{D(),H("camera")})}),Ba.forEach(e=>{e.addEventListener("click",()=>{D(),H("gallery")})}),za.forEach(e=>{e.addEventListener("click",()=>{D(),H("camera-captured")})}),Ta.forEach(e=>{e.addEventListener("click",st)}),Ra.forEach(e=>{e.addEventListener("click",()=>{D();const t=!e.classList.contains("is-selected");e.classList.toggle("is-selected",t),e.setAttribute("aria-pressed",String(t))})}),ja.forEach(e=>{e.addEventListener("click",()=>{if(D(),!B){ua();return}H("preview")})}),Oa.forEach(e=>{e.addEventListener("click",()=>{D(),H("remove")})}),Ua.forEach(e=>{e.addEventListener("click",nt)}),Ha.forEach(e=>{e.addEventListener("click",()=>{D(),H("preview")})}),Na.forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.featureImageTarget;t&&(da(),Fe(t))})}),Va.forEach(e=>{e.addEventListener("click",()=>{da();const t=!e.classList.contains("is-selected");e.classList.toggle("is-selected",t),e.setAttribute("aria-pressed",String(t))})}),ue.forEach(e=>{e.addEventListener("click",()=>{D();const t=e.classList.contains("is-selected");ue.forEach(i=>{i.classList.remove("is-selected"),i.setAttribute("aria-expanded","false")}),e.classList.toggle("is-selected",!t),e.setAttribute("aria-expanded",String(!t))})}),ce(1,{source:"init"}),K(1,{source:"init"}),n.forEach((e,t)=>{e.addEventListener("click",()=>{T(Number(e.dataset.step),{source:"card"})}),e.addEventListener("keydown",i=>{var F,v;const l=i.key;if(!["ArrowRight","ArrowDown","ArrowLeft","ArrowUp","Home","End"].includes(l))return;i.preventDefault();let f=t;(l==="ArrowRight"||l==="ArrowDown")&&(f=(t+1)%n.length),(l==="ArrowLeft"||l==="ArrowUp")&&(f=(t-1+n.length)%n.length),l==="Home"&&(f=0),l==="End"&&(f=n.length-1),(F=n[f])==null||F.focus(),T(Number((v=n[f])==null?void 0:v.dataset.step),{source:"keyboard"})})}),p==null||p.addEventListener("click",()=>{T(Je(),{source:"previous"})}),o==null||o.addEventListener("click",()=>{T(ie(),{source:"next"})}),d==null||d.addEventListener("click",()=>{Ye=!1,ge(!M)}),k){let e=0,t=0,i=!1;k.addEventListener("pointerdown",l=>{var f;l.button===0&&(l.target.closest("input, button, .register-keyboard, .lesion-image-flow")||(i=!0,e=l.clientX,t=l.clientY,(f=k.setPointerCapture)==null||f.call(k,l.pointerId)))}),k.addEventListener("pointerup",l=>{if(!i)return;i=!1;const f=l.clientX-e,F=l.clientY-t;Math.abs(f)<46||Math.abs(f)<Math.abs(F)||T(f<0?ie():Je(),{source:"swipe"})}),k.addEventListener("pointercancel",()=>{i=!1})}"IntersectionObserver"in window&&new IntersectionObserver(([t])=>{pe=t.isIntersecting,a.classList.toggle("is-inview",pe),Be(pe)},{threshold:.12,rootMargin:"-4% 0px -4% 0px"}).observe(a),document.addEventListener("dermalert:langchange",e=>{var t;ze(((t=e.detail)==null?void 0:t.lang)||Ne())}),a.style.setProperty("--flow-duration",`${Oe}ms`),ze(),Ie(),T(se,{source:"init"})}function It(s=document){const a=s.querySelector("#faq");if(!a||a.dataset.faqWired==="true")return;a.dataset.faqWired="true";const r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,c=[a.querySelector("#faq-title"),a.querySelector("#faq-sub")];if(c.forEach((o,d)=>{o&&(o.style.opacity="0",o.style.transform="translateY(16px)",o.style.transition=`opacity 600ms ease ${d*80}ms, transform 600ms ease ${d*80}ms`)}),"IntersectionObserver"in window&&!r){const o=new IntersectionObserver(d=>{d.forEach(h=>{h.isIntersecting&&(h.target.style.opacity="1",h.target.style.transform="translateY(0)",o.unobserve(h.target))})},{threshold:.2});c.forEach(d=>d&&o.observe(d))}else c.forEach(o=>{o&&(o.style.opacity="1",o.style.transform="translateY(0)")});const n=Array.from(a.querySelectorAll(".faq-item"));function u(o,d,h,g,x){x?(o.classList.add("bg-[#2F488A]","text-white"),o.classList.remove("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.add("bg-[#2F488A]","text-white/95"),d.classList.remove("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),g&&(g.classList.remove("text-[#1D366F]","dark:text-white"),g.classList.add("text-white")),h.classList.remove("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"),h.classList.add("text-white","border-white/40")):(o.classList.remove("bg-[#2F488A]","text-white"),o.classList.add("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.remove("bg-[#2F488A]","text-white/95"),d.classList.add("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),g&&(g.classList.remove("text-white"),g.classList.add("text-[#1D366F]","dark:text-white")),h.classList.remove("text-white","border-white/40"),h.classList.add("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"))}function m(o,d){const h=o.querySelector(".faq-trigger"),g=o.querySelector(".faq-panel"),x=o.querySelector(".faq-icon"),P=o.querySelector(".faq-title"),k=x==null?void 0:x.querySelector(".plus"),A=x==null?void 0:x.querySelector(".minus");if(o.classList.toggle("is-open",d),u(h,g,x,P,d),d){if(r)g.style.height="auto";else{g.style.overflow="hidden",g.style.height="auto";const _=g.scrollHeight;g.style.height="0px",requestAnimationFrame(()=>{g.style.transition="height 260ms ease",g.style.height=_+"px"}),setTimeout(()=>{g.style.transition="",g.style.height="auto",g.style.overflow=""},300)}k==null||k.classList.add("hidden"),A==null||A.classList.remove("hidden")}else{const _=g.scrollHeight;g.style.height=_+"px",g.style.overflow="hidden",requestAnimationFrame(()=>{g.style.transition=r?"":"height 220ms ease",g.style.height="0px"}),setTimeout(()=>{g.style.transition="",g.style.overflow=""},r?0:240),k==null||k.classList.remove("hidden"),A==null||A.classList.add("hidden")}}if(n.forEach((o,d)=>m(o,d===0)),n.forEach(o=>{o.querySelector(".faq-trigger").addEventListener("click",()=>{const h=!o.classList.contains("is-open");n.forEach(g=>g!==o&&m(g,!1)),m(o,h)})}),a.querySelector(".faq-cta")){const o="faqShimmer"+Math.random().toString(36).slice(2),d=document.createElement("style");d.textContent=`
      @keyframes ${o} {
