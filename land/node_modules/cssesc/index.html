<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>cssesc Build status Code coverage status - DermAlert</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#cssescvalue-options" class="md-nav__link">
    <span class="md-ellipsis">
      cssesc(value, options)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="cssesc(value, options)">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#isidentifier" class="md-nav__link">
    <span class="md-ellipsis">
      isIdentifier
    </span>
  </a>
  ...
  <a href="#wrap" class="md-nav__link">
    <span class="md-ellipsis">
      wrap
          ...
          <li class="md-nav__item">
  <a href="#escapeeverything" class="md-nav__link">
    <span class="md-ellipsis">
      escapeEverything
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#overriding-the-default-options-globally" class="md-nav__link">
    <span class="md-ellipsis">
      Overriding the default options globally
          ...
          <li class="md-nav__item">
  <a href="#cssescversion" class="md-nav__link">
    <span class="md-ellipsis">
      cssesc.version
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#using-the-cssesc-binary" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="cssesc">cssesc <a href="https://travis-ci.org/mathiasbynens/cssesc"><img alt="Build status" src="https://travis-ci.org/mathiasbynens/cssesc.svg?branch=master"></a> <a href="https://codecov.io/gh/mathiasbynens/cssesc"><img alt="Code coverage status" src="https://img.shields.io/codecov/c/github/mathiasbynens/cssesc.svg"></a></h1>
...
<pre><code class="language-bash">npm install cssesc
</code></pre>
<p>In a browser:</p>
<pre><code class="language-html">&lt;script src="cssesc.js"&gt;&lt;/script&gt;
</code></pre>
<p>In <a href="https://nodejs.org/">Node.js</a>:</p>
<pre><code class="language-js">const cssesc = require('cssesc');
</code></pre>
<p>In Ruby using <a href="https://github.com/borodean/ruby-cssesc">the <code>ruby-cssesc</code> wrapper gem</a>:</p>
<pre><code class="language-bash">gem install ruby-cssesc
</code></pre>
<pre><code class="language-ruby">require 'ruby-cssesc'
...
<pre><code class="language-bash">gem install sassy-escape
</code></pre>
...
<h2 id="api">API</h2>
<h3 id="cssescvalue-options"><code>cssesc(value, options)</code></h3>
...
<pre><code class="language-js">cssesc('Ich ♥ Bücher');
// → 'Ich \\2665  B\\FC cher'
...
<h4 id="isidentifier"><code>isIdentifier</code></h4>
...
<pre><code class="language-js">cssesc('123a2b');
// → '123a2b'
...
<h4 id="quotes"><code>quotes</code></h4>
...
<pre><code class="language-js">cssesc('Lorem ipsum "dolor" sit \'amet\' etc.');
...
<h4 id="escapeeverything"><code>escapeEverything</code></h4>
...
<pre><code class="language-js">cssesc('lolwat"foo\'bar', {
  'escapeEverything': true
});
// → '\\6C\\6F\\6C\\77\\61\\74\\"\\66\\6F\\6F\\\'\\62\\61\\72'
// → "\\6C\\6F\\6C\\77\\61\\74\\\"\\66\\6F\\6F\\'\\62\\61\\72"
</code></pre>
<h4 id="overriding-the-default-options-globally">Overriding the default options globally</h4>
...
<pre><code class="language-js">// Read the global default setting for `escapeEverything`:
...
<pre><code class="language-bash">$ cssesc --identifier 'föo ♥ bår 𝌆 baz'
f\F6o\ \2665\ b\E5r\ \1D306\ baz
</code></pre>
