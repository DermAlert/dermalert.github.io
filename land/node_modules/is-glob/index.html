<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>is-glob NPM version NPM monthly downloads NPM total downloads Build Status - DermAlert</title>
  ...
  <a href="#default-behavior" class="md-nav__link">
    <span class="md-ellipsis">
      Default behavior
          ...
          <li class="md-nav__item">
  <a href="#option-strict" class="md-nav__link">
    <span class="md-ellipsis">
      Option strict
    </span>
  </a>
...
<h1 id="is-glob">is-glob <a href="https://www.npmjs.com/package/is-glob"><img alt="NPM version" src="https://img.shields.io/npm/v/is-glob.svg?style=flat"></a> <a href="https://npmjs.org/package/is-glob"><img alt="NPM monthly downloads" src="https://img.shields.io/npm/dm/is-glob.svg?style=flat"></a> <a href="https://npmjs.org/package/is-glob"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/is-glob.svg?style=flat"></a> <a href="https://github.com/micromatch/is-glob/actions"><img alt="Build Status" src="https://img.shields.io/github/workflow/status/micromatch/is-glob/dev"></a></h1>
<blockquote>
...
<pre><code class="language-sh">$ npm install --save is-glob
</code></pre>
...
<pre><code class="language-js">var isGlob = require('is-glob');
</code></pre>
...
<pre><code class="language-js">isGlob('!foo.js');
isGlob('*.js');
isGlob('**/abc.js');
isGlob('abc/*.js');
...
<p>Extglobs</p>
<pre><code class="language-js">isGlob('abc/@(a).js');
isGlob('abc/!(a).js');
isGlob('abc/+(a).js');
isGlob('abc/*(a).js');
isGlob('abc/?(a).js');
...
<pre><code class="language-js">isGlob('abc.js');
...
<pre><code class="language-js">isGlob(['**/*.js']);
isGlob(['foo.js']);
//=&gt; false
</code></pre>
...
<p><strong>True</strong></p>
<p>Patterns that have glob characters or regex patterns will return <code>true</code>:</p>
<pre><code class="language-js">isGlob('!foo.js', {strict: false});
...
<p>Extglobs</p>
<pre><code class="language-js">isGlob('abc/@(a).js', {strict: false});
