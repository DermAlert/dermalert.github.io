<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>API Documentation - DermAlert</title>
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#parser-function" class="md-nav__link">
    <span class="md-ellipsis">
      parser function
    </span>
  </a>
  
    <nav class="md-nav" aria-label="parser function">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#parsertransform-options" class="md-nav__link">
    <span class="md-ellipsis">
      parser([transform], [options])
          ...
          <li class="md-nav__item">
  <a href="#parserattributeprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.attribute([props])
          ...
          <li class="md-nav__item">
  <a href="#parserclassnameprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.className([props])
          ...
          <li class="md-nav__item">
  <a href="#parsercombinatorprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.combinator([props])
          ...
          <li class="md-nav__item">
  <a href="#parsercommentprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.comment([props])
          ...
          <li class="md-nav__item">
  <a href="#parseridprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.id([props])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parsernestingprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.nesting([props])
          ...
          <li class="md-nav__item">
  <a href="#parserpseudoprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.pseudo([props])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parserrootprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.root([props])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parserselectorprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.selector([props])
          ...
          <li class="md-nav__item">
  <a href="#parserstringprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.string([props])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parsertagprops" class="md-nav__link">
    <span class="md-ellipsis">
      parser.tag([props])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parseruniversalprops" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#nodetype" class="md-nav__link">
    <span class="md-ellipsis">
      node.type
          ...
          <li class="md-nav__item">
  <a href="#nodeparent" class="md-nav__link">
    <span class="md-ellipsis">
      node.parent
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#nodetostring-stringnode-or-node" class="md-nav__link">
    <span class="md-ellipsis">
      node.toString(), String(node), or '' + node
          ...
          <li class="md-nav__item">
  <a href="#nodenext-nodeprev" class="md-nav__link">
    <span class="md-ellipsis">
      node.next() &amp; node.prev()
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#nodereplacewithnode" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#noderemove" class="md-nav__link">
    <span class="md-ellipsis">
      node.remove()
          ...
          <li class="md-nav__item">
  <a href="#nodecloneopts" class="md-nav__link">
    <span class="md-ellipsis">
      node.clone([opts])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#nodeisatpositionline-column" class="md-nav__link">
    <span class="md-ellipsis">
      node.isAtPosition(line, column)
          ...
          <li class="md-nav__item">
  <a href="#nodespaces" class="md-nav__link">
    <span class="md-ellipsis">
      node.spaces
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#nodesource" class="md-nav__link">
    <span class="md-ellipsis">
      node.source
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#nodesourceindex" class="md-nav__link">
    <span class="md-ellipsis">
      node.sourceIndex
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#container-types" class="md-nav__link">
    <span class="md-ellipsis">
      Container types
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Container types">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#containernodes" class="md-nav__link">
    <span class="md-ellipsis">
      container.nodes
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#containerfirst-containerlast" class="md-nav__link">
    <span class="md-ellipsis">
      container.first &amp; container.last
          ...
          <li class="md-nav__item">
  <a href="#containeratindex" class="md-nav__link">
    <span class="md-ellipsis">
      container.at(index)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#containeratpositionline-column" class="md-nav__link">
    <span class="md-ellipsis">
      container.atPosition(line, column)
          ...
          <li class="md-nav__item">
  <a href="#containerindexnode" class="md-nav__link">
    <span class="md-ellipsis">
      container.index(node)
          ...
          <li class="md-nav__item">
  <a href="#containerlength" class="md-nav__link">
    <span class="md-ellipsis">
      container.length
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#container-array-iterators" class="md-nav__link">
    <span class="md-ellipsis">
      container Array iterators
          ...
          <li class="md-nav__item">
  <a href="#containereachcallback" class="md-nav__link">
    <span class="md-ellipsis">
      container.each(callback)
          ...
          <li class="md-nav__item">
  <a href="#containerwalkcallback" class="md-nav__link">
    <span class="md-ellipsis">
      container.walk(callback)
          ...
          <li class="md-nav__item">
  <a href="#containerwalk-proxies" class="md-nav__link">
    <span class="md-ellipsis">
      container.walk proxies
          ...
          <li class="md-nav__item">
  <a href="#containersplitcallback" class="md-nav__link">
    <span class="md-ellipsis">
      container.split(callback)
          ...
          <li class="md-nav__item">
  <a href="#containerprependnode-containerappendnode" class="md-nav__link">
    <span class="md-ellipsis">
      container.prepend(node) &amp; container.append(node)
          ...
          <li class="md-nav__item">
  <a href="#containerinsertbeforeold-new-containerinsertafterold-new" class="md-nav__link">
    <span class="md-ellipsis">
      container.insertBefore(old, new) &amp; container.insertAfter(old, new)
          ...
          <li class="md-nav__item">
  <a href="#containerremovechildnode" class="md-nav__link">
    <span class="md-ellipsis">
      container.removeChild(node)
          ...
          <li class="md-nav__item">
  <a href="#containerremoveall-or-containerempty" class="md-nav__link">
    <span class="md-ellipsis">
      container.removeAll() or container.empty()
        ...
        <li class="md-nav__item">
  <a href="#root-nodes" class="md-nav__link">
    <span class="md-ellipsis">
      Root nodes
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Root nodes">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#roottrailingcomma" class="md-nav__link">
    <span class="md-ellipsis">
      root.trailingComma
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#selector-nodes" class="md-nav__link">
    <span class="md-ellipsis">
      Selector nodes
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#pseudo-nodes" class="md-nav__link">
    <span class="md-ellipsis">
      Pseudo nodes
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#attribute-nodes" class="md-nav__link">
    <span class="md-ellipsis">
      Attribute nodes
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Attribute nodes">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#attributequoted" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.quoted
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#attributequalifiedattribute" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.qualifiedAttribute
          ...
          <li class="md-nav__item">
  <a href="#attributeoffsetofpart" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.offsetOf(part)
          ...
          <li class="md-nav__item">
  <a href="#attributerawsunquoted" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.raws.unquoted
          ...
          <li class="md-nav__item">
  <a href="#attributespaces" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.spaces
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#attributeraws" class="md-nav__link">
    <span class="md-ellipsis">
      attribute.raws
    </span>
  </a>
  ...
  <a href="#processor" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Processor">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#processoroptions" class="md-nav__link">
    <span class="md-ellipsis">
      ProcessorOptions
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#processprocesssyncselectors-options" class="md-nav__link">
    <span class="md-ellipsis">
      process|processSync(selectors, [options])
          ...
          <li class="md-nav__item">
  <a href="#astastsyncselectors-options" class="md-nav__link">
    <span class="md-ellipsis">
      ast|astSync(selectors, [options])
          ...
          <li class="md-nav__item">
  <a href="#transformtransformsyncselectors-options" class="md-nav__link">
    <span class="md-ellipsis">
      transform|transformSync(selectors, [options])
          ...
          <li class="md-nav__item">
  <a href="#error-handling-within-selector-processors" class="md-nav__link">
    <span class="md-ellipsis">
      Error Handling Within Selector Processors
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Error Handling Within Selector Processors">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#async-error-example" class="md-nav__link">
    <span class="md-ellipsis">
      Async Error Example
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#synchronous-error-example" class="md-nav__link">
    <span class="md-ellipsis">
...
<pre><code class="language-js">const parser = require('postcss-selector-parser');
</code></pre>
<h3 id="parsertransform-options"><code>parser([transform], [options])</code></h3>
<p>Creates a new <code>processor</code> instance</p>
<pre><code class="language-js">const processor = parser();
</code></pre>
<p>Or, with optional transform function</p>
<pre><code class="language-js">const transform = selectors =&gt; {
...
<h3 id="parserattributeprops"><code>parser.attribute([props])</code></h3>
...
<h3 id="parserclassnameprops"><code>parser.className([props])</code></h3>
...
<h3 id="parsercombinatorprops"><code>parser.combinator([props])</code></h3>
...
<p>Notes:
* <strong>Descendant Combinators</strong> The value of descendant combinators created by the
  ...
  <code>node.raws.spaces.before</code>, <code>node.raws.spaces.after</code>, or <code>node.raws.value</code>.
* <strong>Named Combinators</strong> Although, nonstandard and unlikely to ever become a standard,
  ...
  original value for the combinator name is stored in <code>node.raws.value</code>.</p>
<h3 id="parsercommentprops"><code>parser.comment([props])</code></h3>
...
<h3 id="parseridprops"><code>parser.id([props])</code></h3>
...
<h3 id="parsernestingprops"><code>parser.nesting([props])</code></h3>
...
<h3 id="parserpseudoprops"><code>parser.pseudo([props])</code></h3>
...
<h3 id="parserrootprops"><code>parser.root([props])</code></h3>
...
<h3 id="parserselectorprops"><code>parser.selector([props])</code></h3>
...
<h3 id="parserstringprops"><code>parser.string([props])</code></h3>
...
<h3 id="parsertagprops"><code>parser.tag([props])</code></h3>
...
<h3 id="parseruniversalprops"><code>parser.universal([props])</code></h3>
...
<h3 id="nodetype"><code>node.type</code></h3>
...
<h3 id="nodeparent"><code>node.parent</code></h3>
<p>Returns the parent node.</p>
<pre><code class="language-js">root.nodes[0].parent === root;
</code></pre>
<h3 id="nodetostring-stringnode-or-node"><code>node.toString()</code>, <code>String(node)</code>, or <code>'' + node</code></h3>
<p>Returns a string representation of the node.</p>
<pre><code class="language-js">const id = parser.id({value: 'search'});
console.log(String(id));
// =&gt; #search
</code></pre>
<h3 id="nodenext-nodeprev"><code>node.next()</code> &amp; <code>node.prev()</code></h3>
<p>Returns the next/previous child of the parent node.</p>
<pre><code class="language-js">const next = id.next();
if (next &amp;&amp; next.type !== 'combinator') {
    throw new Error('Qualified IDs are not allowed!');
}
</code></pre>
<h3 id="nodereplacewithnode"><code>node.replaceWith(node)</code></h3>
<p>Replace a node with another.</p>
<pre><code class="language-js">const attr = selectors.first.first;
...
<h3 id="noderemove"><code>node.remove()</code></h3>
<p>Removes the node from its parent node.</p>
<pre><code class="language-js">if (node.type === 'id') {
    node.remove();
}
</code></pre>
<h3 id="nodecloneopts"><code>node.clone([opts])</code></h3>
<p>Returns a copy of a node, detached from any parent containers that the
original might have had.</p>
<pre><code class="language-js">const cloned = node.clone();
</code></pre>
<h3 id="nodeisatpositionline-column"><code>node.isAtPosition(line, column)</code></h3>
...
<h3 id="nodespaces"><code>node.spaces</code></h3>
...
<h3 id="nodesource"><code>node.source</code></h3>
...
<h3 id="nodesourceindex"><code>node.sourceIndex</code></h3>
...
<h3 id="containernodes"><code>container.nodes</code></h3>
...
<h3 id="containerfirst-containerlast"><code>container.first</code> &amp; <code>container.last</code></h3>
<p>The first/last child of the container.</p>
<pre><code class="language-js">selector.first === selector.nodes[0];
selector.last === selector.nodes[selector.nodes.length - 1];
</code></pre>
<h3 id="containeratindex"><code>container.at(index)</code></h3>
...
<h3 id="containeratpositionline-column"><code>container.atPosition(line, column)</code></h3>
<p>Returns the node at the source position <code>line</code> and <code>column</code>.</p>
<pre><code class="language-js">// Input: :not(.foo),\n#foo &gt; :matches(ol, ul)
selector.atPosition(1, 1); // =&gt; :not(.foo)
selector.atPosition(2, 1); // =&gt; \n#foo
</code></pre>
<p>Arguments:</p>
<ul>
<li><code>line</code>: The line number of the node to return.</li>
<li><code>column</code>: The column number of the node to return.</li>
</ul>
<h3 id="containerindexnode"><code>container.index(node)</code></h3>
...
<h3 id="containerlength"><code>container.length</code></h3>
<p>Proxy to the length of the container's nodes.</p>
<pre><code class="language-js">container.length === container.nodes.length
</code></pre>
<h3 id="container-array-iterators"><code>container</code> Array iterators</h3>
...
<h3 id="containereachcallback"><code>container.each(callback)</code></h3>
...
<pre><code class="language-js">let className;
...
<h3 id="containerwalkcallback"><code>container.walk(callback)</code></h3>
<p>Like <code>container#each</code>, but will also iterate child nodes as long as they are
<code>container</code> types.</p>
<pre><code class="language-js">selectors.walk((selector, index) =&gt; {
    // all nodes
});
</code></pre>
<p>Arguments:</p>
...
<h3 id="containerwalk-proxies"><code>container.walk</code> proxies</h3>
...
<h3 id="containersplitcallback"><code>container.split(callback)</code></h3>
...
<h3 id="containerprependnode-containerappendnode"><code>container.prepend(node)</code> &amp; <code>container.append(node)</code></h3>
...
<h3 id="containerinsertbeforeold-new-containerinsertafterold-new"><code>container.insertBefore(old, new)</code> &amp; <code>container.insertAfter(old, new)</code></h3>
<p>Add a node before or after an existing node in a container:</p>
<pre><code class="language-js">selectors.walk(selector =&gt; {
    if (selector.type !== 'class') {
...
<h3 id="containerremovechildnode"><code>container.removeChild(node)</code></h3>
...
<h3 id="containerremoveall-or-containerempty"><code>container.removeAll()</code> or <code>container.empty()</code></h3>
...
<h3 id="roottrailingcomma"><code>root.trailingComma</code></h3>
...
<h3 id="attributequoted"><code>attribute.quoted</code></h3>
...
<h3 id="attributequalifiedattribute"><code>attribute.qualifiedAttribute</code></h3>
<p>Returns the attribute name qualified with the namespace if one is given.</p>
<h3 id="attributeoffsetofpart"><code>attribute.offsetOf(part)</code></h3>
...
<h3 id="attributerawsunquoted"><code>attribute.raws.unquoted</code></h3>
...
<h3 id="attributespaces"><code>attribute.spaces</code></h3>
...
<h3 id="attributeraws"><code>attribute.raws</code></h3>
...
<h3 id="processprocesssyncselectors-options"><code>process|processSync(selectors, [options])</code></h3>
...
<h3 id="astastsyncselectors-options"><code>ast|astSync(selectors, [options])</code></h3>
...
<p>Note: when the <code>updateSelector</code> option is set, the rule's selector
will be updated with the resulting string.</p>
<h3 id="transformtransformsyncselectors-options"><code>transform|transformSync(selectors, [options])</code></h3>
<p>Like <code>process()</code> and <code>processSync()</code> but after
...
(<a href="http://postcss.org/api/#container-error">documentation</a>).</p>
<h4 id="async-error-example">Async Error Example</h4>
<pre><code class="language-js">let processor = (root) =&gt; {
