<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>postcss-import - DermAlert</title>
  ...
  <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#postcss-import" class="md-skip">
          Pular para conteúdo
        </a>
  ...
  <a href="#load" class="md-nav__link">
    <span class="md-ellipsis">
      load
          ...
          <li class="md-nav__item">
  <a href="#skipduplicates" class="md-nav__link">
    <span class="md-ellipsis">
      skipDuplicates
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#addmodulesdirectories" class="md-nav__link">
    <span class="md-ellipsis">
      addModulesDirectories
          ...
          <li class="md-nav__item">
  <a href="#namelayer" class="md-nav__link">
    <span class="md-ellipsis">
      nameLayer
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#example-with-some-options" class="md-nav__link">
    <span class="md-ellipsis">
      Example with some options
        ...
        <li class="md-nav__item">
  <a href="#dependency-message-support" class="md-nav__link">
    <span class="md-ellipsis">
...
<p><a href="https://travis-ci.org/postcss/postcss-import"><img alt="Build" src="https://img.shields.io/travis/postcss/postcss-import/master"></a>
<a href="https://github.com/postcss/postcss-import/blob/master/CHANGELOG.md"><img alt="Version" src="https://img.shields.io/npm/v/postcss-import"></a>
<a href="https://postcss.org/"><img alt="postcss compatibility" src="https://img.shields.io/npm/dependency-version/postcss-import/peer/postcss"></a></p>
<blockquote>
...
<li>Imports which are not modified (by <code>options.filter</code> or because they are remote
...
<pre><code class="language-console">$ npm install -D postcss-import
</code></pre>
...
<pre><code class="language-css">/* can consume `node_modules`, `web_modules` or local modules */
...
<p>will give you:</p>
<pre><code class="language-css">/* ... content of ../node_modules/cssrecipes-defaults/index.css */
...
<p>Only transform imports for which the test function returns <code>true</code>. Imports for
which the test function returns <code>false</code> will be left as is. The function gets
...
promised content.</p>
<h4 id="skipduplicates"><code>skipDuplicates</code></h4>
...
disable it.</p>
<h4 id="addmodulesdirectories"><code>addModulesDirectories</code></h4>
<p>Type: <code>Array</code><br>
Default: <code>[]</code></p>
...
<h4 id="namelayer"><code>nameLayer</code></h4>
<p>Type: <code>Function</code>
Default: <code>null</code></p>
<p>You can provide a custom naming function for anonymous layers (<code>@import 'baz.css' layer;</code>).
This function gets <code>(index, rootFilename)</code> arguments and should return a unique string.</p>
<p>This option only influences imports without a layer name.
Without this option the plugin will warn on anonymous layers.</p>
...
<h2 id="dependency-message-support"><code>dependency</code> Message Support</h2>
