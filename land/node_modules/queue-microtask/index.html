<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>queue-microtask ci npm downloads javascript style guide - DermAlert</title>
  ...
  <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#queue-microtask" class="md-skip">
          Pular para conteúdo
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#fast-tiny-queuemicrotask-shim-for-modern-engines" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#usage" class="md-nav__link">
    <span class="md-ellipsis">
      usage
        ...
        <li class="md-nav__item">
  <a href="#what-is-queuemicrotask-and-why-would-one-use-it" class="md-nav__link">
    <span class="md-ellipsis">
      What is queueMicrotask and why would one use it?
        ...
        <li class="md-nav__item">
  <a href="#who-is-this-package-for" class="md-nav__link">
    <span class="md-ellipsis">
      Who is this package for?
        ...
        <li class="md-nav__item">
  <a href="#why-not-use-processnexttick" class="md-nav__link">
    <span class="md-ellipsis">
      Why not use process.nextTick?
        ...
        <li class="md-nav__item">
  <a href="#why-not-use-settimeoutfn-0" class="md-nav__link">
    <span class="md-ellipsis">
      Why not use setTimeout(fn, 0)?
        ...
        <li class="md-nav__item">
  <a href="#why-not-use-a-microtask-library-like-immediate-or-asap" class="md-nav__link">
    <span class="md-ellipsis">
      Why not use a microtask library like immediate or asap?
        ...
        <li class="md-nav__item">
  <a href="#what-is-a-shim" class="md-nav__link">
    <span class="md-ellipsis">
      What is a shim?
    </span>
  </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#queuemicrotaskfn" class="md-nav__link">
    <span class="md-ellipsis">
      queueMicrotask(fn)
    </span>
  </a>
...
<h1 id="queue-microtask">queue-microtask <a href="https://github.com/feross/queue-microtask/actions"><img alt="ci" src="https://img.shields.io/github/workflow/status/feross/queue-microtask/ci/master"></a> <a href="https://npmjs.org/package/queue-microtask"><img alt="npm" src="https://img.shields.io/npm/v/queue-microtask.svg"></a> <a href="https://npmjs.org/package/queue-microtask"><img alt="downloads" src="https://img.shields.io/npm/dm/queue-microtask.svg"></a> <a href="https://standardjs.com"><img alt="javascript style guide" src="https://img.shields.io/badge/code_style-standard-brightgreen.svg"></a></h1>
<h3 id="fast-tiny-queuemicrotask-shim-for-modern-engines">fast, tiny <a href="https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/queueMicrotask"><code>queueMicrotask</code></a> shim for modern engines</h3>
<ul>
...
<li>Optimal performance in all modern environments</li>
...
<pre><code class="language-js">const queueMicrotask = require('queue-microtask')

queueMicrotask(() =&gt; { /* this will run soon */ })
</code></pre>
<h2 id="what-is-queuemicrotask-and-why-would-one-use-it">What is <code>queueMicrotask</code> and why would one use it?</h2>
...
<h2 id="why-not-use-processnexttick">Why not use <code>process.nextTick</code>?</h2>
...
<h2 id="why-not-use-settimeoutfn-0">Why not use <code>setTimeout(fn, 0)</code>?</h2>
...
<h2 id="why-not-use-a-microtask-library-like-immediate-or-asap">Why not use a microtask library like <a href="https://www.npmjs.com/package/immediate"><code>immediate</code></a> or <a href="https://www.npmjs.com/package/asap"><code>asap</code></a>?</h2>
...
<h2 id="api">API</h2>
<h3 id="queuemicrotaskfn"><code>queueMicrotask(fn)</code></h3>
