...
<html lang="pt" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.14">
        ...
        <title>to-regex-range Donate NPM version NPM monthly downloads NPM total downloads Linux Build Status - DermAlert</title>
   ...
   <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"/><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#to-regex-range" class="md-skip">
          Pular para conteúdo
        </a>
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#optionscapture" class="md-nav__link">
    <span class="md-ellipsis">
      options.capture
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsshorthand" class="md-nav__link">
    <span class="md-ellipsis">
      options.shorthand
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsrelaxzeros" class="md-nav__link">
    <span class="md-ellipsis">
      options.relaxZeros
    </span>
  </a>
  ...
  <a href="#history" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="History">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#v200-2017-04-21" class="md-nav__link">
    <span class="md-ellipsis">
      v2.0.0 - 2017-04-21
    </span>
  </a>
...
<h1 id="to-regex-range">to-regex-range <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=W8YFZ425KND68"><img alt="Donate" src="https://img.shields.io/badge/Donate-PayPal-green.svg" /></a> <a href="https://www.npmjs.com/package/to-regex-range"><img alt="NPM version" src="https://img.shields.io/npm/v/to-regex-range.svg?style=flat" /></a> <a href="https://npmjs.org/package/to-regex-range"><img alt="NPM monthly downloads" src="https://img.shields.io/npm/dm/to-regex-range.svg?style=flat" /></a> <a href="https://npmjs.org/package/to-regex-range"><img alt="NPM total downloads" src="https://img.shields.io/npm/dt/to-regex-range.svg?style=flat" /></a> <a href="https://travis-ci.org/micromatch/to-regex-range"><img alt="Linux Build Status" src="https://img.shields.io/travis/micromatch/to-regex-range.svg?style=flat&amp;label=Travis" /></a></h1>
<blockquote>
...
<pre><code class="language-sh">$ npm install --save to-regex-range
</code></pre>
<details>
...
<pre><code class="language-js">const toRegexRange = require('to-regex-range');
...
<pre><code class="language-js">const source = toRegexRange('15', '95');
//=&gt; 1[5-9]|[2-8][0-9]|9[0-5]
...
<h3 id="optionscapture">options.capture</h3>
...
<pre><code class="language-js">console.log(toRegexRange('-10', '10'));
//=&gt; -[1-9]|-?10|[0-9]

console.log(toRegexRange('-10', '10', { capture: true }));
//=&gt; (-[1-9]|-?10|[0-9])
</code></pre>
<h3 id="optionsshorthand">options.shorthand</h3>
<p><strong>Type</strong>: <code>boolean</code></p>
<p><strong>Deafault</strong>: <code>undefined</code></p>
<p>Use the regex shorthand for <code>[0-9]</code>:</p>
<pre><code class="language-js">console.log(toRegexRange('0', '999999'));
//=&gt; [0-9]|[1-9][0-9]{1,5}

console.log(toRegexRange('0', '999999', { shorthand: true }));
//=&gt; \d|[1-9]\d{1,5}
</code></pre>
<h3 id="optionsrelaxzeros">options.relaxZeros</h3>
<p><strong>Type</strong>: <code>boolean</code></p>
<p><strong>Default</strong>: <code>true</code></p>
<p>This option relaxes matching for leading zeros when when ranges are zero-padded.</p>
<pre><code class="language-js">const source = toRegexRange('-0010', '0010');
const regex = new RegExp(`^${source}$`);
...
<pre><code class="language-js">const source = toRegexRange('-0010', '0010', { relaxZeros: false });
const regex = new RegExp(`^${source}$`);
...
<pre><code class="language-js">toRegexRange('51', '29');
</code></pre>
<p>Is effectively flipped to:</p>
<pre><code class="language-js">toRegexRange('29', '51');
//=&gt; 29|[3-4][0-9]|5[0-1]
</code></pre>
...
<h3 id="v200-2017-04-21">v2.0.0 - 2017-04-21</h3>
...
<a class="glightbox" href="https://c5.patreon.com/external/logo/become_a_patron_button@2x.png" data-type="image" data-width="100%" data-height="auto" data-desc-position="bottom"><img src="https://c5.patreon.com/external/logo/become_a_patron_button@2x.png" height="50"></a>
</a></p>
