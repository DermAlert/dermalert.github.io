<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>Chokidar Weekly downloads Yearly downloads - DermAlert</title>
  ...
  <a href="#persistence" class="md-nav__link">
    <span class="md-ellipsis">
      Persistence
          ...
          <li class="md-nav__item">
  <a href="#path-filtering" class="md-nav__link">
    <span class="md-ellipsis">
      Path filtering
    </span>
  </a>
  ...
  <a href="#errors" class="md-nav__link">
    <span class="md-ellipsis">
      Errors
          ...
          <li class="md-nav__item">
  <a href="#methods-events" class="md-nav__link">
    <span class="md-ellipsis">
      Methods &amp; Events
    </span>
  </a>
  ...
  <a href="#changelog" class="md-nav__link">
    <span class="md-ellipsis">
      Changelog
        ...
        <li class="md-nav__item">
  <a href="#also" class="md-nav__link">
    <span class="md-ellipsis">
      Also
    </span>
  </a>
...
<h1 id="chokidar">Chokidar <a href="https://github.com/paulmillr/chokidar"><img alt="Weekly downloads" src="https://img.shields.io/npm/dw/chokidar.svg"></a> <a href="https://github.com/paulmillr/chokidar"><img alt="Yearly downloads" src="https://img.shields.io/npm/dy/chokidar.svg"></a></h1>
<blockquote>
<p>Minimal and efficient cross-platform file watching library</p>
</blockquote>
<p><a href="https://www.npmjs.com/package/chokidar"><img alt="NPM" src="https://nodei.co/npm/chokidar.png"></a></p>
<h2 id="why">Why?</h2>
...
recursively, or glob patterns.<ul>
...
<li><em>Polling-specific settings</em> (effective when <code>usePolling: true</code>)</li>
...
<ul>
<li><code>npm WARN optional dep failed, continuing fsevents@n.n.n</code></li>
<li>
<p>This message is normal part of how <code>npm</code> handles optional dependencies and is
    not indicative of a problem. Even if accompanied by other related error messages,
    Chokidar should function properly.</p>
</li>
<li>
<p><code>TypeError: fsevents is not a constructor</code></p>
</li>
<li>
<p>Update chokidar by doing <code>rm -rf node_modules package-lock.json yarn.lock &amp;&amp; npm install</code>, or update your dependency that uses chokidar.</p>
</li>
<li>
...
<p>For more detailed changelog, see <a href=".github/full_changelog.md"><code>full_changelog.md</code></a>.
- <strong>v3.5 (Jan 6, 2021):</strong> Support for ARM Macs with Apple Silicon. Fixes for deleted symlinks.
- <strong>v3.4 (Apr 26, 2020):</strong> Support for directory-based symlinks. Fixes for macos file replacement.
- <strong>v3.3 (Nov 2, 2019):</strong> <code>FSWatcher#close()</code> method became async. That fixes IO race conditions related to close method.
- <strong>v3.2 (Oct 1, 2019):</strong> Improve Linux RAM usage by 50%. Race condition fixes. Windows glob fixes. Improve stability by using tight range of dependency versions.
- <strong>v3.1 (Sep 16, 2019):</strong> dotfiles are no longer filtered out by default. Use <code>ignored</code> option if needed. Improve initial Linux scan time by 50%.
- <strong>v3 (Apr 30, 2019):</strong> massive CPU &amp; RAM consumption improvements; reduces deps / package size by a factor of 17x and bumps Node.js requirement to v8.16 and higher.
- <strong>v2 (Dec 29, 2017):</strong> Globs are now posix-style-only; without windows support. Tons of bugfixes.
- <strong>v1 (Apr 7, 2015):</strong> Glob support, symlink support, tons of bugfixes. Node 0.8+ is supported
- <strong>v0.1 (Apr 20, 2012):</strong> Initial release, extracted from <a href="https://github.com/brunch/brunch/blob/9847a065aea300da99bd0753f90354cde9de1261/src/helpers.coffee#L66">Brunch</a></p>
<h2 id="also">Also</h2>
