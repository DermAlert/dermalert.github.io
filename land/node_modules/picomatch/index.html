<!DOCTYPE html><html lang="pt" class="no-js"><head>
  ...
  <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#why-picomatch" class="md-skip">
          Pular para conteúdo
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#why-picomatch" class="md-nav__link">
    <span class="md-ellipsis">
      Why picomatch?
    </span>
  </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#picomatch" class="md-nav__link">
    <span class="md-ellipsis">
      picomatch
    </span>
  </a>
  ...
  <a href="#matchbase" class="md-nav__link">
    <span class="md-ellipsis">
      .matchBase
          ...
          <li class="md-nav__item">
  <a href="#ismatch" class="md-nav__link">
    <span class="md-ellipsis">
      .isMatch
    </span>
  </a>
  ...
  <a href="#scan" class="md-nav__link">
    <span class="md-ellipsis">
      .scan
          ...
          <li class="md-nav__item">
  <a href="#compilere" class="md-nav__link">
    <span class="md-ellipsis">
      .compileRe
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#makere" class="md-nav__link">
    <span class="md-ellipsis">
      .makeRe
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#toregex" class="md-nav__link">
    <span class="md-ellipsis">
      .toRegex
    </span>
  </a>
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#picomatch-options" class="md-nav__link">
    <span class="md-ellipsis">
      Picomatch options
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#scan-options" class="md-nav__link">
    <span class="md-ellipsis">
      Scan Options
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#options-examples" class="md-nav__link">
    <span class="md-ellipsis">
      Options Examples
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Options Examples">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#optionsexpandrange" class="md-nav__link">
    <span class="md-ellipsis">
      options.expandRange
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsformat" class="md-nav__link">
    <span class="md-ellipsis">
      options.format
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsonmatch" class="md-nav__link">
    <span class="md-ellipsis">
      options.onMatch
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsonignore" class="md-nav__link">
    <span class="md-ellipsis">
      options.onIgnore
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#optionsonresult" class="md-nav__link">
    <span class="md-ellipsis">
      options.onResult
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#globbing-features" class="md-nav__link">
    <span class="md-ellipsis">
      Globbing features
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Globbing features">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#basic-globbing" class="md-nav__link">
    <span class="md-ellipsis">
      Basic globbing
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Basic globbing">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#matching-behavior-vs-bash" class="md-nav__link">
    <span class="md-ellipsis">
      Matching behavior vs. Bash
          ...
          <li class="md-nav__item">
  <a href="#advanced-globbing" class="md-nav__link">
    <span class="md-ellipsis">
      Advanced globbing
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Advanced globbing">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#extglobs" class="md-nav__link">
    <span class="md-ellipsis">
      Extglobs
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#posix-brackets" class="md-nav__link">
    <span class="md-ellipsis">
      POSIX brackets
    </span>
  </a>
  ...
  <a href="#braces" class="md-nav__link">
    <span class="md-ellipsis">
      Braces
          ...
          <li class="md-nav__item">
  <a href="#matching-special-characters-as-literals" class="md-nav__link">
    <span class="md-ellipsis">
      Matching special characters as literals
        ...
        <li class="md-nav__item">
  <a href="#library-comparisons" class="md-nav__link">
    <span class="md-ellipsis">
      Library Comparisons
    </span>
  </a>
  ...
  <a href="#benchmarks" class="md-nav__link">
    <span class="md-ellipsis">
      Benchmarks
        ...
        <li class="md-nav__item">
  <a href="#philosophies" class="md-nav__link">
    <span class="md-ellipsis">
      Philosophies
    </span>
  </a>
...
<p><br>
<br></p>
<h2 id="why-picomatch">Why picomatch?</h2>
<ul>
...
<pre><code class="language-sh">npm install --save picomatch
</code></pre>
<p><br></p>
...
<pre><code class="language-js">const pm = require('picomatch');
const isMatch = pm('*.js');
...
<pre><code class="language-js">const picomatch = require('picomatch');
...
<h3 id="parse"><a href="lib/picomatch.js#L199">.parse</a></h3>
...
<h4 id="optionsexpandrange">options.expandRange</h4>
...
<h4 id="optionsformat">options.format</h4>
<p><strong>Type</strong>: <code>function</code></p>
<p><strong>Default</strong>: <code>undefined</code></p>
...
<h4 id="optionsonmatch">options.onMatch</h4>
...
<h4 id="optionsonignore">options.onIgnore</h4>
...
<h4 id="optionsonresult">options.onResult</h4>
...
<pre><code class="language-js">console.log(pm.makeRe('[[:word:]]+', { posix: true }));
//=&gt; /^(?:(?=.)[A-Za-z0-9_]+\/?)$/
</code></pre>
...
<p>See the <a href="https://www.gnu.org/software/bash/manual/html_node/Pattern-Matching.html">Bash Reference Manual</a> for more information.</p>
...
<p>Examples:</p>
<pre><code class="language-js">console.log(pm.makeRe('foo/bar \\(1\\)'));
...
<p>Thus, given that there is no canonical glob specification to use as a single source of truth when differences of opinion arise regarding behavior, sometimes we have to implement our best judgement and rely on feedback from users to make improvements.</p>
