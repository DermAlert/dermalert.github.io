<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>Fraction.js - ℚ in JavaScript - DermAlert</title>
  ...
  <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#fractionjs-q-in-javascript" class="md-skip">
          Pular para conteúdo
        </a>
...
<h1 id="fractionjs-q-in-javascript">Fraction.js - ℚ in JavaScript</h1>
<p><a href="https://npmjs.org/package/fraction.js" title="View this project on npm"><img alt="NPM Package" src="https://img.shields.io/npm/v/fraction.js.svg?style=flat"></a>
<a href="http://opensource.org/licenses/MIT"><img alt="MIT license" src="http://img.shields.io/badge/license-MIT-brightgreen.svg"></a></p>
...
<pre><code class="language-javascript">1 / 98 * 98 // = 0.9999999999999999
</code></pre>
<p>If you need more precision or just want a fraction as a result, just include <em>Fraction.js</em>:</p>
<pre><code class="language-javascript">var Fraction = require('fraction.js');
// or
import Fraction from 'fraction.js';
</code></pre>
<p>and give it a trial:</p>
<pre><code class="language-javascript">Fraction(1).div(98).mul(98) // = 1
</code></pre>
...
<pre><code class="language-javascript">var x = new Fraction(1.88);
var res = x.toFraction(true); // String "1 22/25"
</code></pre>
<h1 id="examples-motivation">Examples / Motivation</h1>
<p>A simple example might be</p>
<pre><code class="language-javascript">var f = new Fraction("9.4'31'"); // 9.4313131313131...
f.mul([-4, 3]).mod("4.'8'"); // 4.88888888888888...
</code></pre>
<p>The result is</p>
<pre><code class="language-javascript">console.log(f.toFraction()); // -4154 / 1485
</code></pre>
<p>You could of course also access the sign (s), numerator (n) and denominator (d) on your own:</p>
<pre><code class="language-javascript">f.s * f.n / f.d = -1 * 4154 / 1485 = -2.797306...
</code></pre>
<p>If you would try to calculate it yourself, you would come up with something like:</p>
<pre><code class="language-javascript">(9.4313131 * (-4 / 3)) % 4.888888 = -2.797308133...
</code></pre>
...
<p>P({3}):</p>
<pre><code class="language-javascript">var p = new Fraction([3].length, 6).toString(); // 0.1(6)
</code></pre>
<p>P({1, 4}):</p>
<pre><code class="language-javascript">var p = new Fraction([1, 4].length, 6).toString(); // 0.(3)
</code></pre>
<p>P({2, 4, 6}):</p>
<pre><code class="language-javascript">var p = new Fraction([2, 4, 6].length, 6).toString(); // 0.5
</code></pre>
...
<pre><code class="language-javascript">var deg = 57; // 57°
...
<pre><code class="language-javascript">var x = "/", s = "";
...
<pre><code class="language-javascript">var f = new Fraction("-6.(3416)");
...
<pre><code class="language-javascript">new Fraction(numerator, denominator);
new Fraction([numerator, denominator]);
new Fraction({n: numerator, d: denominator});
</code></pre>
<h2 id="integers">Integers</h2>
<pre><code class="language-javascript">new Fraction(123);
</code></pre>
<h2 id="doubles">Doubles</h2>
<pre><code class="language-javascript">new Fraction(55.4);
</code></pre>
...
<pre><code class="language-javascript">new Fraction("123.45");
...
<pre><code class="language-javascript">new Fraction(3, 2); // 3/2 = 1.5
</code></pre>
...
<pre><code class="language-javascript">var f = new Fraction("123.32");
...
<pre><code class="language-javascript">function formatDecimal(str) {
...
<pre><code class="language-javascript">var f = new Fraction('-1/2');
...
<p>Returns the modulus (rest of the division) of the actual object and n (this % n). It's a much more precise <a href="#fmod-impreciseness-circumvented">fmod()</a> if you like. Please note that <em>mod()</em> is just like the modulo operator of most programming languages. If you want a mathematical correct modulo, see <a href="#mathematical-correct-modulo">here</a>.</p>
...
<h2 id="fraction-roundtomultiple">Fraction roundTo(multiple)</h2>
<p>Rounds a fraction to the closest multiple of another fraction. </p>
...
<pre><code class="language-javascript">var f = new Fraction('88/33');
...
<p>Installing fraction.js is as easy as cloning this repo or use the following command:</p>
<pre><code>npm install fraction.js
</code></pre>
<h1 id="using-fractionjs-with-the-browser">Using Fraction.js with the browser</h1>
<pre><code class="language-html">&lt;script src="fraction.js"&gt;&lt;/script&gt;
&lt;script&gt;
    console.log(Fraction("123/456"));
&lt;/script&gt;
</code></pre>
<h1 id="using-fractionjs-with-typescript">Using Fraction.js with TypeScript</h1>
<pre><code class="language-js">import Fraction from "fraction.js";
console.log(Fraction("123/456"));
</code></pre>
...
<p>Copyright (c) 2023, <a href="https://raw.org/">Robert Eisele</a>
