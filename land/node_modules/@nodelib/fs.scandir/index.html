<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>@nodelib/fs.scandir - DermAlert</title>
  ...
  <link href="../../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#nodelibfsscandir" class="md-skip">
          Pular para conteúdo
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#scandirpath-optionsorsettings-callback" class="md-nav__link">
    <span class="md-ellipsis">
      .scandir(path, [optionsOrSettings], callback)
          ...
          <li class="md-nav__item">
  <a href="#scandirsyncpath-optionsorsettings" class="md-nav__link">
    <span class="md-ellipsis">
      .scandirSync(path, [optionsOrSettings])
    </span>
  </a>
  
    <nav class="md-nav" aria-label=".scandirSync(path, [optionsOrSettings])">
      <ul class="md-nav__list">
  ...
  <a href="#old-and-modern-mode" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="old and modern mode">
      <ul class="md-nav__list">
...
<pre><code class="language-console">npm install @nodelib/fs.scandir
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-ts">import * as fsScandir from '@nodelib/fs.scandir';
...
<pre><code class="language-ts">fsScandir.scandir('path', (error, entries) =&gt; { /* … */ });
...
<pre><code class="language-ts">const entries = fsScandir.scandirSync('path');
...
<pre><code class="language-ts">const settings = new fsScandir.Settings({ followSymbolicLinks: false });
...
<h2 id="old-and-modern-mode"><code>old</code> and <code>modern</code> mode</h2>
