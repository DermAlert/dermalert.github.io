<!DOCTYPE html><html lang="pt" class="no-js"><head>
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.21">
        ...
        <title>@nodelib/fs.walk - DermAlert</title>
  ...
  <link href="../../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><script src="../../../../assets/javascripts/glightbox.min.js"></script><style id="glightbox-style">
    ...
    <div data-md-component="skip">
        ...
        <a href="#nodelibfswalk" class="md-skip">
          Pular para conteúdo
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#bulb-highlights" class="md-nav__link">
    <span class="md-ellipsis">
      :bulb: Highlights
    </span>
  </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#walkpath-optionsorsettings-callback" class="md-nav__link">
    <span class="md-ellipsis">
      .walk(path, [optionsOrSettings], callback)
          ...
          <li class="md-nav__item">
  <a href="#walkstreampath-optionsorsettings" class="md-nav__link">
    <span class="md-ellipsis">
      .walkStream(path, [optionsOrSettings])
          ...
          <li class="md-nav__item">
  <a href="#walksyncpath-optionsorsettings" class="md-nav__link">
    <span class="md-ellipsis">
      .walkSync(path, [optionsOrSettings])
    </span>
  </a>
  
    <nav class="md-nav" aria-label=".walkSync(path, [optionsOrSettings])">
      <ul class="md-nav__list">
  ...
  <a href="#path" class="md-nav__link">
    <span class="md-ellipsis">
      path
          ...
          <li class="md-nav__item">
  <a href="#optionsorsettings" class="md-nav__link">
    <span class="md-ellipsis">
      optionsOrSettings
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#settingsoptions" class="md-nav__link">
    <span class="md-ellipsis">
      Settings([options])
    </span>
  </a>
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#basepath" class="md-nav__link">
    <span class="md-ellipsis">
      basePath
    </span>
  </a>
  ...
  <a href="#concurrency" class="md-nav__link">
    <span class="md-ellipsis">
      concurrency
          ...
          <li class="md-nav__item">
  <a href="#deepfilter" class="md-nav__link">
    <span class="md-ellipsis">
      deepFilter
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#entryfilter" class="md-nav__link">
    <span class="md-ellipsis">
      entryFilter
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#errorfilter" class="md-nav__link">
    <span class="md-ellipsis">
      errorFilter
    </span>
  </a>
  ...
  <a href="#throwerroronbrokensymboliclink" class="md-nav__link">
    <span class="md-ellipsis">
      throwErrorOnBrokenSymbolicLink
          ...
          <li class="md-nav__item">
  <a href="#pathsegmentseparator" class="md-nav__link">
    <span class="md-ellipsis">
...
<pre><code class="language-console">npm install @nodelib/fs.walk
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-ts">import * as fsWalk from '@nodelib/fs.walk';
...
<pre><code class="language-ts">fsWalk.walk('path', (error, entries) =&gt; { /* … */ });
fsWalk.walk('path', {}, (error, entries) =&gt; { /* … */ });
...
<pre><code class="language-ts">const stream = fsWalk.walkStream('path');
...
<pre><code class="language-ts">const entries = fsWalk.walkSync('path');
...
<pre><code class="language-ts">const settings = new fsWalk.Settings({ followSymbolicLinks: true });
...
<pre><code class="language-ts">fsWalk.walkSync('root'); // → ['root/file.txt']
...
<pre><code class="language-ts">// Skip all directories that starts with `node_modules`
...
<pre><code class="language-ts">// Exclude all `.js` files from results
...
<pre><code class="language-ts">// Skip all ENOENT errors
...
<h3 id="throwerroronbrokensymboliclink"><code>throwErrorOnBrokenSymbolicLink</code></h3>
<ul>
<li>Type: <code>boolean</code></li>
...
<h3 id="pathsegmentseparator"><code>pathSegmentSeparator</code></h3>
<ul>
<li>Type: <code>string</code></li>
...
<pre><code class="language-ts">interface FileSystemAdapter {
