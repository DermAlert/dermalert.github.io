...
<nav class="md-nav md-nav--secondary" aria-label="Índice">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#tested-on" class="md-nav__link">
    <span class="md-ellipsis">
      Tested on
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#table-of-main-contents" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#filter-the-given-paths" class="md-nav__link">
    <span class="md-ellipsis">
      Filter the given paths
          ...
          <li class="md-nav__item">
  <a href="#as-the-filter-function" class="md-nav__link">
    <span class="md-ellipsis">
      As the filter function
          ...
          <li class="md-nav__item">
  <a href="#win32-paths-will-be-handled" class="md-nav__link">
    <span class="md-ellipsis">
      Win32 paths will be handled
        ...
        <li class="md-nav__item">
  <a href="#why-another-ignore" class="md-nav__link">
    <span class="md-ellipsis">
      Why another ignore?
    </span>
  </a>
...
<table><thead>
  ...
  <td colspan="2" align="center">
    ...
    <img src="https://github.com/kaelzhang/node-ignore/actions/workflows/nodejs.yml/badge.svg" alt="Build Status"></a>
  </td>
  <td align="center">
...
<pre><code class="language-sh">npm i ignore
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="language-js">import ignore from 'ignore'
...
<pre><code class="language-js">paths.filter(ig.createFilter()); // ['.abc/d/e.js']
</code></pre>
<h3 id="win32-paths-will-be-handled">Win32 paths will be handled</h3>
<pre><code class="language-js">ig.filter(['.abc\\a.js', '.abc\\d\\e.js'])
// if the code above runs on windows, the result will be
// ['.abc\\d\\e.js']
</code></pre>
<h2 id="why-another-ignore">Why another ignore?</h2>
<ul>
<li>
...
<li>
<p><code>ignore</code> don't cares about sub-modules of git projects.</p>
</li>
<li>
...
<h2 id="addpattern-string-ignore-this">.add(pattern: string | Ignore): this</h2>
<h2 id="addpatterns-array-this">.add(patterns: Array<string | ignore>): this</string></h2>
<ul>
...
<p>instead.</p>
<h2 id="filterpaths-arraypathname-arraypathname">.filter(paths: Array&lt;Pathname&gt;): Array&lt;Pathname&gt;</h2>
<pre><code class="language-ts">type Pathname = string
</code></pre>
...
<h3 id="pathname-conventions"><code>Pathname</code> Conventions:</h3>
<h4 id="1-pathname-should-be-a-pathrelatived-pathname">1. <code>Pathname</code> should be a <code>path.relative()</code>d pathname</h4>
...
<pre><code class="language-js">// WRONG, an error will be thrown
ig.ignores('./abc')
...
<pre><code class="language-js">// First, we add a ignore pattern to ignore a directory
ig.add('config/')
...
<h2 id="ignorespathname-pathname-boolean">.ignores(pathname: Pathname): boolean</h2>
<blockquote>
<p>new in 3.2.0</p>
</blockquote>
...
<h2 id="testpathname-pathname-since-500">.test(pathname: Pathname) since 5.0.0</h2>
<p>Returns <code>TestResult</code></p>
<pre><code class="language-ts">interface TestResult {
  ignored: boolean
...
<h2 id="static-ignoreispathvalidpathname-boolean-since-500">static <code>ignore.isPathValid(pathname): boolean</code> since 5.0.0</h2>
...
<pre><code class="language-js">ignore.isPathValid('./foo')  // false
</code></pre>
<h2 id="ignoreoptions">ignore(options)</h2>
<h3 id="optionsignorecase-since-400"><code>options.ignorecase</code> since 4.0.0</h3>
...
<h3 id="optionsignorecase-boolean-since-520"><code>options.ignoreCase?: boolean</code> since 5.2.0</h3>
<p>Which is alternative to <code>options.ignoreCase</code></p>
<h3 id="optionsallowrelativepaths-boolean-since-520"><code>options.allowRelativePaths?: boolean</code> since 5.2.0</h3>
...
<h2 id="upgrade-4x-5x">Upgrade 4.x -&gt; 5.x</h2>
...
<pre><code class="language-ts">.ignores(pathname: Pathname): boolean
...
<p>If there are invalid pathnames, the conversion and filtration should be done by users.</p>
<pre><code class="language-js">import {isPathValid} from 'ignore' // introduced in 5.0.0
...
<h2 id="upgrade-3x-4x">Upgrade 3.x -&gt; 4.x</h2>
...
<h2 id="upgrade-2x-3x">Upgrade 2.x -&gt; 3.x</h2>
<ul>
