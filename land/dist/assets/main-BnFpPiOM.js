(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(n){if(n.ep)return;n.ep=!0;const l=a(n);fetch(n.href,l)}})();const j=`<!-- HEADER fixo + spacer dinâmico -->\r
...
>
  <div class="max-w-[1200px] mx-auto px-6">
    ...
    <header class="text-center pre-anim" data-anim="rise-blur" style="--anim-delay:.05s">
      <h2
        id="about-title"
        class="title-anim text-[#2F488A] dark:text-white font-extrabold leading-tight tracking-tight text-[48px]"
      ...
      <p
        id="about-sub"
        class="subtitle-anim mt-3 text-[#2F488A] dark:text-white/90 text-[32px] leading-snug"
        data-i18n="about_sub"
      >
    ...
    <div class="mt-8 relative">
      ...
      <div
        id="about-media"
        class="rounded-[16px] overflow-hidden w-full pre-anim"
        data-anim="slide-up"
      ...
      >
        <p
          class="font-semibold text-white text-[35px] leading-[40px] tracking-[0.5px]"
    ...
    >
      <p
        class="text-[#1D366F] font-normal text-[21px] leading-[32px] tracking-[0.5px]"
...
`;function Z(){if(!document.getElementById("hero"))return;const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=document.getElementById("hero-title"),s=document.getElementById("hero-sub"),n=[a,s];function l(t,d=0){t&&(t.style.opacity="0",t.style.transform="translateY(16px) scale(.995)",t.style.transition=`opacity 600ms ease ${d}ms, transform 600ms ease ${d}ms`,t.style.willChange="opacity, transform")}function o(t){t&&(t.style.opacity="1",t.style.transform="translateY(0) scale(1)",setTimeout(()=>{t.style.willChange="auto"},700))}function u(t,d=1.02){if(!t)return;const m=t.style.transition?t.style.transition+", transform 220ms ease":"transform 220ms ease";t.style.transition=m;const p=()=>{e||(t.style.transform=`scale(${d})`,t.style.willChange="transform")},c=()=>{t.style.transform="scale(1)",t.style.willChange="auto"};t.addEventListener("pointerenter",p),t.addEventListener("pointerleave",c),t.addEventListener("focus",p),t.addEventListener("blur",c)}if(l(a,0),l(s,100),"IntersectionObserver"in window&&!e){const t=new IntersectionObserver(d=>{d.forEach(m=>{m.isIntersecting&&(o(m.target),t.unobserve(m.target))})},{threshold:.2});n.forEach(d=>d&&t.observe(d))}else n.forEach(o);u(a,1.02),u(s,1.015)}function U(r=document){var h,f;const e=r.querySelector("#about-dermalert");if(!e||e.dataset.aboutWired==="true")return;e.dataset.aboutWired="true";const a=((h=window.matchMedia)==null?void 0:h.call(window,"(prefers-reduced-motion: reduce)").matches)??!1,s=((f=window.matchMedia)==null?void 0:f.call(window,"(hover: hover) and (pointer: fine)").matches)??!1,n=e.querySelector("#about-title"),l=e.querySelector("#about-sub"),o=e.querySelector("#about-media"),u=e.querySelector("#about-img"),t=e.querySelector("#about-highlight"),d=e.querySelector("#about-note"),m=(i,g=0)=>{i&&(i.style.opacity="0",i.style.transform="translateY(16px) scale(.995)",i.style.transition=`opacity 700ms cubic-bezier(.22,.75,.25,1) ${g}ms, transform 700ms cubic-bezier(.22,.75,.25,1) ${g}ms`,i.style.willChange="opacity, transform")},p=i=>{i&&(i.classList.remove("pre-anim"),i.classList.add("is-inview"),i.style.opacity="1",i.style.transform="translateY(0) scale(1)",setTimeout(()=>{i.style.willChange="auto"},800))},c=[n,l,o,t,d];if(c.forEach((i,g)=>m(i,g*90)),!a&&"IntersectionObserver"in window){const i=new IntersectionObserver(g=>{g.forEach(b=>{b.isIntersecting&&(p(b.target),i.unobserve(b.target))})},{threshold:.22,rootMargin:"0px 0px -10% 0px"});c.forEach(g=>g&&i.observe(g))}else c.forEach(i=>i&&p(i));if(s&&o){const i=()=>{a||(o.style.transition="transform 220ms ease",o.style.transform="scale(1.02)",o.style.willChange="transform")},g=()=>{o.style.transform="scale(1)",o.style.willChange="auto"};o.addEventListener("pointerenter",i),o.addEventListener("pointerleave",g),o.addEventListener("focus",i,!0),o.addEventListener("blur",g,!0),u&&(u.setAttribute("draggable","false"),u.style.userSelect="none",u.style.pointerEvents="none")}}function G(){const r=document.getElementById("features-pills");if(!r)return;const e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,a=Array.from(r.querySelectorAll("li"));a.forEach((n,l)=>{n.style.opacity="0",n.style.transform="translateY(8px)",n.style.transition=`opacity 480ms ease ${l*60}ms, transform 480ms ease ${l*60}ms`;const o=n.style.transition?n.style.transition+", transform 160ms ease":"transform 160ms ease";n.style.transition=o;const u=()=>{e||(n.style.transform="translateY(-2px) scale(1.01)",n.style.willChange="transform")},t=()=>{n.style.transform="translateY(0) scale(1)",n.style.willChange="auto"};n.addEventListener("pointerenter",u),n.addEventListener("pointerleave",t),n.addEventListener("focusin",u),n.addEventListener("focusout",t)});const s=n=>{n.style.opacity="1",n.style.transform="translateY(0) scale(1)"};if("IntersectionObserver"in window&&!e){const n=new IntersectionObserver(l=>{l.forEach(o=>{o.isIntersecting&&(s(o.target),n.unobserve(o.target))})},{threshold:.15});a.forEach(l=>n.observe(l))}else a.forEach(s)}function W(r=document){const e=r.querySelector("#functionalities");if(!e||e.dataset.featuresBaseWired==="true")return;e.dataset.featuresBaseWired="true",function(){if(!e.querySelector(".bg-animate"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){e.classList.add("inview");return}const i=new IntersectionObserver(([g])=>{g.isIntersecting&&(e.classList.add("inview"),i.disconnect())},{root:null,threshold:.2,rootMargin:"-10% 0px -10% 0px"});i.observe(e)}();const a=c=>{c&&(c.style.display="block",requestAnimationFrame(()=>c.style.opacity="1"))},s=c=>{c&&(c.style.opacity="0",c.style.display="none")},n=e.querySelector("#func-illustration"),l=[e.querySelector("#figma-embed-1"),e.querySelector("#figma-embed-2"),e.querySelector("#figma-embed-3")],o=Array.from(e.querySelectorAll("#func-cards .func-card")),u=c=>{const h=Number(c)-1;l.forEach((f,i)=>i===h?a(f):s(f)),n&&(n.classList.add("hidden"),n.style.opacity="0",n.style.display="none"),o.forEach(f=>{const i=f.dataset.step===String(c);f.classList.toggle("opacity-50",!i);const g=f.querySelector(".func-cta");g&&g.classList.toggle("hidden",!i),f.setAttribute("aria-pressed",i?"true":"false")})};o.length&&(o.forEach(c=>{const h=Number(c.dataset.step);c.addEventListener("click",()=>u(h)),c.addEventListener("keydown",f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),u(h))})}),u(1));const t=[e.querySelector("#figma-embed-m1"),e.querySelector("#figma-embed-m2"),e.querySelector("#figma-embed-m3")],d=e.querySelector("#func-illustration-mob"),m=Array.from(e.querySelectorAll("details.func-card[data-step]")),p=c=>{const h=Number(c)-1;t.forEach((f,i)=>i===h?a(f):s(f)),d&&(d.classList.add("hidden"),d.style.opacity="0",d.style.display="none")};if(m.length){m.forEach(h=>{h.addEventListener("toggle",()=>{if(!h.open)return;const f=Number(h.dataset.step);p(f),m.forEach(i=>{i!==h&&i.open&&(i.open=!1)})})});const c=m.find(h=>h.open)||m[0];c&&!c.open&&(c.open=!0),p(Number(c.dataset.step||1))}}function Y(r=document){const e=r.querySelector("#faq");if(!e||e.dataset.faqWired==="true")return;e.dataset.faqWired="true";const a=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=[e.querySelector("#faq-title"),e.querySelector("#faq-sub")];if(s.forEach((t,d)=>{t&&(t.style.opacity="0",t.style.transform="translateY(16px)",t.style.transition=`opacity 600ms ease ${d*80}ms, transform 600ms ease ${d*80}ms`)}),"IntersectionObserver"in window&&!a){const t=new IntersectionObserver(d=>{d.forEach(m=>{m.isIntersecting&&(m.target.style.opacity="1",m.target.style.transform="translateY(0)",t.unobserve(m.target))})},{threshold:.2});s.forEach(d=>d&&t.observe(d))}else s.forEach(t=>{t&&(t.style.opacity="1",t.style.transform="translateY(0)")});const n=Array.from(e.querySelectorAll(".faq-item"));function l(t,d,m,p,c){c?(t.classList.add("bg-[#2F488A]","text-white"),t.classList.remove("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.add("bg-[#2F488A]","text-white/95"),d.classList.remove("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),p&&(p.classList.remove("text-[#1D366F]","dark:text-white"),p.classList.add("text-white")),m.classList.remove("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"),m.classList.add("text-white","border-white/40")):(t.classList.remove("bg-[#2F488A]","text-white"),t.classList.add("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),d.classList.remove("bg-[#2F488A]","text-white/95"),d.classList.add("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),p&&(p.classList.remove("text-white"),p.classList.add("text-[#1D366F]","dark:text-white")),m.classList.remove("text-white","border-white/40"),m.classList.add("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"))}function o(t,d){const m=t.querySelector(".faq-trigger"),p=t.querySelector(".faq-panel"),c=t.querySelector(".faq-icon"),h=t.querySelector(".faq-title"),f=c==null?void 0:c.querySelector(".plus"),i=c==null?void 0:c.querySelector(".minus");if(t.classList.toggle("is-open",d),l(m,p,c,h,d),d){if(a)p.style.height="auto";else{p.style.overflow="hidden",p.style.height="auto";const g=p.scrollHeight;p.style.height="0px",requestAnimationFrame(()=>{p.style.transition="height 260ms ease",p.style.height=g+"px"}),setTimeout(()=>{p.style.transition="",p.style.height="auto",p.style.overflow=""},300)}f==null||f.classList.add("hidden"),i==null||i.classList.remove("hidden")}else{const g=p.scrollHeight;p.style.height=g+"px",p.style.overflow="hidden",requestAnimationFrame(()=>{p.style.transition=a?"":"height 220ms ease",p.style.height="0px"}),setTimeout(()=>{p.style.transition="",p.style.overflow=""},a?0:240),f==null||f.classList.remove("hidden"),i==null||i.classList.add("hidden")}}if(n.forEach((t,d)=>o(t,d===0)),n.forEach(t=>{t.querySelector(".faq-trigger").addEventListener("click",()=>{const m=!t.classList.contains("is-open");n.forEach(p=>p!==t&&o(p,!1)),o(t,m)})}),e.querySelector(".faq-cta")){const t="faqShimmer"+Math.random().toString(36).slice(2),d=document.createElement("style");d.textContent=`
      @keyframes ${t} {
