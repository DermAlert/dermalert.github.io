      ...
      <header class="md:pt-2 text-center px-4">
        ...
        <p id="faq-sub"
          class="mt-3 font-medium text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px]
                  leading-[130%] text-[#4B4B4B] dark:text-white/85 max-w-[600px] mx-auto">
...
`,U=`<!-- ===== FOOTER (full-bleed + i18n + dark mode) ===== -->
...
`;function Z(){if(!document.getElementById("hero"))return;const t=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=document.getElementById("hero-title"),o=document.getElementById("hero-sub"),n=[s,o];function i(e,r=0){e&&(e.style.opacity="0",e.style.transform="translateY(16px) scale(.995)",e.style.transition=`opacity 600ms ease ${r}ms, transform 600ms ease ${r}ms`,e.style.willChange="opacity, transform")}function c(e){e&&(e.style.opacity="1",e.style.transform="translateY(0) scale(1)",setTimeout(()=>{e.style.willChange="auto"},700))}function p(e,r=1.02){if(!e)return;const d=e.style.transition?e.style.transition+", transform 220ms ease":"transform 220ms ease";e.style.transition=d;const l=()=>{t||(e.style.transform=`scale(${r})`,e.style.willChange="transform")},f=()=>{e.style.transform="scale(1)",e.style.willChange="auto"};e.addEventListener("pointerenter",l),e.addEventListener("pointerleave",f),e.addEventListener("focus",l),e.addEventListener("blur",f)}if(i(s,0),i(o,100),"IntersectionObserver"in window&&!t){const e=new IntersectionObserver(r=>{r.forEach(d=>{d.isIntersecting&&(c(d.target),e.unobserve(d.target))})},{threshold:.2});n.forEach(r=>r&&e.observe(r))}else n.forEach(c);p(s,1.02),p(o,1.015)}function G(a=document){var f,g;const t=a.querySelector("#about-dermalert");if(!t||t.dataset.aboutWired==="true")return;t.dataset.aboutWired="true";const s=((f=window.matchMedia)==null?void 0:f.call(window,"(prefers-reduced-motion: reduce)").matches)??!1,o=((g=window.matchMedia)==null?void 0:g.call(window,"(hover: hover) and (pointer: fine)").matches)??!1,n=(u,m=0)=>{u&&(u.style.opacity="0",u.style.transform="translateY(16px) scale(.995)",u.style.transition=`opacity 600ms ease ${m}ms, transform 600ms ease ${m}ms`,u.style.willChange="opacity, transform")},i=u=>{u&&(u.style.opacity="1",u.style.transform="translateY(0) scale(1)",setTimeout(()=>{u.style.willChange="auto"},700))},c=t.querySelector("#about-title"),p=t.querySelector("#about-sub"),e=t.querySelector("#about-media"),r=t.querySelector("#about-img"),d=t.querySelector("#about-highlight"),l=t.querySelector("#about-note");if([c,p,e,d,l].forEach((u,m)=>n(u,m*70)),!s&&"IntersectionObserver"in window){const u=new IntersectionObserver(m=>{m.forEach(x=>{x.isIntersecting&&(i(x.target),u.unobserve(x.target))})},{threshold:.2});[c,p,e,d,l].forEach(m=>m&&u.observe(m))}else[c,p,e,d,l].forEach(i);if(o&&e){const u=()=>{s||(e.style.transition="transform 220ms ease",e.style.transform="scale(1.02)",e.style.willChange="transform")},m=()=>{e.style.transform="scale(1)",e.style.willChange="auto"};e.addEventListener("pointerenter",u),e.addEventListener("pointerleave",m),e.addEventListener("focus",u,!0),e.addEventListener("blur",m,!0),r&&(r.setAttribute("draggable","false"),r.style.userSelect="none",r.style.pointerEvents="none")}}function Y(){const a=document.getElementById("features-pills");if(!a)return;const t=window.matchMedia("(prefers-reduced-motion: reduce)").matches,s=Array.from(a.querySelectorAll("li"));s.forEach((n,i)=>{n.style.opacity="0",n.style.transform="translateY(8px)",n.style.transition=`opacity 480ms ease ${i*60}ms, transform 480ms ease ${i*60}ms`;const c=n.style.transition?n.style.transition+", transform 160ms ease":"transform 160ms ease";n.style.transition=c;const p=()=>{t||(n.style.transform="translateY(-2px) scale(1.01)",n.style.willChange="transform")},e=()=>{n.style.transform="translateY(0) scale(1)",n.style.willChange="auto"};n.addEventListener("pointerenter",p),n.addEventListener("pointerleave",e),n.addEventListener("focusin",p),n.addEventListener("focusout",e)});const o=n=>{n.style.opacity="1",n.style.transform="translateY(0) scale(1)"};if("IntersectionObserver"in window&&!t){const n=new IntersectionObserver(i=>{i.forEach(c=>{c.isIntersecting&&(o(c.target),n.unobserve(c.target))})},{threshold:.15});s.forEach(i=>n.observe(i))}else s.forEach(o)}const C={1:{src:"home/features/cadastrar.svg",alt:"Cadastro do paciente"},2:{src:"home/features/cadastrar_escuro.png",alt:"Anamnese e foto"},3:{src:"home/features/cadastrar_vintage.png",alt:"Triagem e pesquisa"}};function $(a=document){const t=a.querySelector("#functionalities");if(!t||t.dataset.featuresBaseWired==="true")return;t.dataset.featuresBaseWired="true";const s=t.querySelector("#func-illustration"),o=Array.from(t.querySelectorAll("#func-cards .func-card")),n=e=>{if(!s||!o.length)return;const r=C[e];r&&(s.style.opacity=0,setTimeout(()=>{s.src=r.src,s.alt=r.alt,s.style.opacity=1},120)),o.forEach(d=>{const l=d.dataset.step===String(e);d.classList.toggle("opacity-50",!l);const f=d.querySelector(".func-cta");f&&f.classList.toggle("hidden",!l),d.setAttribute("aria-pressed",l?"true":"false")})};s&&o.length&&(o.forEach(e=>{const r=e.dataset.step;e.addEventListener("click",()=>n(r)),e.addEventListener("keydown",d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),n(r))})}),n(1));const i=t.querySelector("#func-illustration-mob"),c=Array.from(t.querySelectorAll("details.func-card[data-step]")),p=e=>{if(!i)return;const r=C[e];r&&(i.style.opacity=0,setTimeout(()=>{i.src=r.src,i.alt=r.alt,i.style.opacity=1},120))};if(i&&c.length){c.forEach(r=>{r.addEventListener("toggle",()=>{if(!r.open)return;const d=r.dataset.step;p(d),c.forEach(l=>{l!==r&&l.open&&(l.open=!1)})})});const e=c.find(r=>r.open)||c[0];e&&!e.open&&(e.open=!0),e&&p(e.dataset.step||"1")}}function Q(a=document){const t=a.querySelector("#faq");if(!t||t.dataset.faqWired==="true")return;t.dataset.faqWired="true";const s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o=[t.querySelector("#faq-title"),t.querySelector("#faq-sub")];if(o.forEach((e,r)=>{e&&(e.style.opacity="0",e.style.transform="translateY(16px)",e.style.transition=`opacity 600ms ease ${r*80}ms, transform 600ms ease ${r*80}ms`)}),"IntersectionObserver"in window&&!s){const e=new IntersectionObserver(r=>{r.forEach(d=>{d.isIntersecting&&(d.target.style.opacity="1",d.target.style.transform="translateY(0)",e.unobserve(d.target))})},{threshold:.2});o.forEach(r=>r&&e.observe(r))}else o.forEach(e=>{e&&(e.style.opacity="1",e.style.transform="translateY(0)")});const n=Array.from(t.querySelectorAll(".faq-item"));function i(e,r,d,l,f){f?(e.classList.add("bg-[#2F488A]","text-white"),e.classList.remove("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),r.classList.add("bg-[#2F488A]","text-white/95"),r.classList.remove("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),l&&(l.classList.remove("text-[#1D366F]","dark:text-white"),l.classList.add("text-white")),d.classList.remove("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"),d.classList.add("text-white","border-white/40")):(e.classList.remove("bg-[#2F488A]","text-white"),e.classList.add("hover:bg-[#F7FAFF]","dark:hover:bg-white/10"),r.classList.remove("bg-[#2F488A]","text-white/95"),r.classList.add("bg-white","dark:bg-white/5","text-[#1D366F]/90","dark:text-white/85"),l&&(l.classList.remove("text-white"),l.classList.add("text-[#1D366F]","dark:text-white")),d.classList.remove("text-white","border-white/40"),d.classList.add("text-[#1D366F]","dark:text-white/90","border-[#CBD8EE]","dark:border-white/20"))}function c(e,r){const d=e.querySelector(".faq-trigger"),l=e.querySelector(".faq-panel"),f=e.querySelector(".faq-icon"),g=e.querySelector(".faq-title"),u=f==null?void 0:f.querySelector(".plus"),m=f==null?void 0:f.querySelector(".minus");if(e.classList.toggle("is-open",r),i(d,l,f,g,r),r){if(s)l.style.height="auto";else{l.style.overflow="hidden",l.style.height="auto";const x=l.scrollHeight;l.style.height="0px",requestAnimationFrame(()=>{l.style.transition="height 260ms ease",l.style.height=x+"px"}),setTimeout(()=>{l.style.transition="",l.style.height="auto",l.style.overflow=""},300)}u==null||u.classList.add("hidden"),m==null||m.classList.remove("hidden")}else{const x=l.scrollHeight;l.style.height=x+"px",l.style.overflow="hidden",requestAnimationFrame(()=>{l.style.transition=s?"":"height 220ms ease",l.style.height="0px"}),setTimeout(()=>{l.style.transition="",l.style.overflow=""},s?0:240),u==null||u.classList.remove("hidden"),m==null||m.classList.add("hidden")}}if(n.forEach((e,r)=>c(e,r===0)),n.forEach(e=>{e.querySelector(".faq-trigger").addEventListener("click",()=>{const d=!e.classList.contains("is-open");n.forEach(l=>l!==e&&c(l,!1)),c(e,d)})}),t.querySelector(".faq-cta")){const e="faqShimmer"+Math.random().toString(36).slice(2),r=document.createElement("style");r.textContent=`
      @keyframes ${e} {
